//==================================================
// avalon.mobile 1.1 2014.1.25 ，mobile 注意： 只能用于IE10及高版本的标准浏览器
//==================================================
(function(DOC) {
    ...
    function scanTag(elem, vmodels, node) {
        ...
        //--> ms-if-loop(110) --> ms-attr(970) ...--> ms-each(1400)-->ms-with(1500)--〉ms-duplex(2000)垫后        var a = elem.getAttribute(prefix + "skip")
