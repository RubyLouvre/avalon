(function (global, factory) {
       ...
       function avalon$1(el) {
               return new avalon$1.init(el)
       }

       avalon$1.init = function (el) {
               this[0] = this.element = el
       }

       avalon$1.fn = avalon$1.prototype = avalon$1.init.prototype

       avalon$1.shadowCopy = function (destination, source) {
       ...
       function defaultParse(cur, pre, binding) {
               cur[binding.name] = avalon$1.parseExpr(binding)
       }
       var rword = /[^, ]+/g
       ...
       avalon$1.shadowCopy(avalon$1, {
               ...
               log: function () {
                       if (hasConsole && avalon$1.config.debug) {
               ...
               css: function (node, name, value, fn) {
                       //读写删除元素节点的样式
                       if (node instanceof avalon$1) {
                               node = node[0]
                       }
                       if (node.nodeType !== 1) {
                               return
                       }
                       var prop = avalon$1.camelize(name)
                       name = avalon$1.cssName(prop) || /* istanbul ignore next*/ prop
                       if (value === void 0 || typeof value === 'boolean') { //获取样式
                               ...
                               if (isFinite(value) && !avalon$1.cssNumber[prop]) {
                                       value += 'px'
                               }
               ...
               Array: {
                       ...
                       remove: function (target, item) {
                               ...
                               if (~index)
                                       return avalon$1.Array.removeAt(target, index)
                               return false
                       }
               }
       })
       ...
       */
       ...
       var _window = typeof window$1 === 'object' ? window$1 : 
       ...
       avalon$1.shadowCopy(avalon$1, browser)

       avalon$1.quote = typeof JSON !== 'undefined' ? JSON.stringify : new function () {
       ...
       var tos = avalon$1.inspect
       var class2type = {}
       'Boolean Number String Function Array Date RegExp Object Error'.replace(avalon$1.rword, function (name) {
           class2type['[object ' + name + ']'] = name.toLowerCase()
       })

       avalon$1.type = function (obj) { //取得目标的类型
           if (obj == null) {
               return String(obj)
           }
       ...
       avalon$1.isFunction = typeof alert === 'object' ? function (fn) {
           try {
       ...
       avalon$1.isWindow = isWindowModern(avalon$1.window) ?
       ...
       function isPlainObjectCompact(obj, key) {
           if (!obj || avalon$1.type(obj) !== 'object' || obj.nodeType || avalon$1.isWindow(obj)) {
               return false
           }
       ...
       avalon$1.isPlainObject = /\[native code\]/.test(Object.getPrototypeOf) ?
               isPlainObjectModern : isPlainObjectCompact


       //与jQuery.extend方法，可用于浅拷贝，深拷贝
       avalon$1.mix = avalon$1.fn.mix = function () {
           ...
           //确保接受方为一个复杂的数据类型
           if (typeof target !== 'object' && !avalon$1.isFunction(target)) {
               target = {}
           }
           ...
           for (; i < length; i++) {
               ...
               if ((options = arguments[i]) != null) {
                   for (name in options) {
                       ...
                       if (deep && copy && (avalon$1.isPlainObject(copy) || (copyIsArray = Array.isArray(copy)))) {
                           ...
                           if (copyIsArray) {
                               ...
                               clone = src && avalon$1.isPlainObject(src) ? src : {}
                           }

                           target[name] = avalon$1.mix(deep, clone, copy)
                       } else if (copy !== void 0) {
                           target[name] = copy
                       }
                   }
       ...
       new function welcome() {
           var welcomeIntro = ["%cavalon.js %c" + avalon$1.version + " %cin debug mode, %cmore...", "color: rgb(114, 157, 52); font-weight: normal;", "color: rgb(85, 85, 85); font-weight: normal;", "color: rgb(85, 85, 85); font-weight: normal;", "color: rgb(82, 140, 224); font-weight: normal; text-decoration: underline;"];
       ...
       function steinkern(settings) {
           for (var p in settings) {
                /* istanbul ignore if */
               if (!avalon$1.ohasOwn.call(settings, p))
                   continue
               var val = settings[p]
       ...
       var plugins = {
           interpolate: function (array) {
               ...
               var o = avalon$1.escapeRegExp(openTag)
               var c = avalon$1.escapeRegExp(closeTag)
       ...
       function markID(fn) {
           /* istanbul ignore next */
           return fn.uuid || (fn.uuid = avalon$1.makeHashCode('e'))
       }
       var UUID = 1
       ...
       var directives = avalon$1.directives

       var config = avalon$1.config
       var cache = Cache
       var quote = avalon$1.quote
       var win = avalon$1.window
       var doc = avalon$1.document
       var root = avalon$1.root
       var W3C = avalon$1.modern
       ...
       function filterBy(array, search) {
           ...
           var args = avalon$1.slice(arguments, 2)
           var stype = avalon$1.type(search)
           if (stype === 'function') {
               var criteria = search
               ...
               if (search === '') {
                   ...
                   var reg = new RegExp(avalon$1.escapeRegExp(search), 'i')
       ...
       function selectBy(data, array, defaults) {
           if (avalon$1.isObject(data) && !Array.isArray(data)) {
               var target = []
       ...
       function convertArray(array) {
           var ret = [], i = 0
           avalon$1.each(array, function (key, value) {
               ret[i++] = {
                   value: value,
                   key: key
               }
       ...
       var filters = avalon$1.filters


       avalon$1.escapeHtml = escapeFilter

       avalon$1.mix(filters, {
       ...
       function VText(text) {
           this.nodeName = '#text'
           this.nodeValue = text
           this.skipContent = !avalon$1.config.rexpr.test(text)
       }
       ...
       VText.prototype = {
           ...
           toDOM: function () {
               ...
               if (this.dom)
                   return this.dom
               var v = avalon$1._decode(this.nodeValue)
       ...
       VElement.prototype = {
           ...
           toDOM: function () {
               ...
               if (avalon$1.modern && svgTags[tagName]) {
                   dom = createSVG(tagName)
               } else if (!avalon$1.modern && (VMLTags[tagName] || rvml.test(tagName))) {
               ...
               for (var i in props) {
                   ...
                   if (skipFalseAndFunction(val)) {
                       if (specalAttrs[i] && avalon$1.msie < 8) {
                   ...
                   default:
                       if (!this.isVoidTag) {
                           this.children.forEach(function (c) {
                               c && dom.appendChild(avalon$1.vdom(c, 'toDOM'))
                           })
                       }
                       break
               }
           ...
           toHTML: function () {
               ...
               for (var i in props) {
                   var val = props[i]
                   if (skipFalseAndFunction(val)) {
                       arr.push(i + '=' + avalon$1.quote(props[i] + ''))
                   }
               }
               ...
               if (this.children) {
                   str += this.children.map(function (c) {
                       return c ? avalon$1.vdom(c, 'toHTML') : ''
                   }).join('')
               }
       ...
       var svgTags = avalon$1.oneObject('circle,defs,ellipse,image,line,' +
       ...
       var VMLTags = avalon$1.oneObject('shape,line,polyline,rect,roundrect,oval,arc,' +
       ...
       VFragment.prototype = {
           ...
           toDOM: function () {
               ...
               for (var i = 0, el; el = this.children[i++];) {
                   f.appendChild(avalon$1.vdom(el, 'toDOM'))
               }
           ...
           toHTML: function () {
               return this.children.map(function (a) {
                   return avalon$1.vdom(a, 'toHTML')
               }).join('')
           }
       }

       avalon$1.vdom = avalon$1.vdomAdaptor = function (obj, method) {
       ...
       avalon$1.shadowCopy(avalon$1.vdom, mix)


       avalon$1.domize = function (a) {
           return avalon$1.vdom(a, 'toDOM')
       }
       ...
       avalon$1.contains = fixContains
       //IE6-11的文档对象没有contains
       if (avalon$1.browser) {
           if (avalon$1.msie < 10) {
               avalon$1.cloneNode = fixCloneNode
           }
       ...
       //firefox 到11时才有outerHTML
           if (window.HTMLElement && !avalon$1.root.outerHTML) {
       ...
       'add,remove'.replace(avalon$1.rword, function (method) {
           avalon$1.fn[method + 'Class'] = function (cls) {
               var el = this[0] || {}
       ...
       avalon$1.shadowCopy(avalon$1.fn, {
           ...
           for (var attrName in attrs) {
               ...
               if (attrName === 'href' || attrName === 'src') {
                   ...
                   var isInnate = rsvg.test(node) ? false :
                           (!avalon$1.modern && isVML(node)) ? true :
       ...
       avalon$1.parseJSON = typeof JSON === 'object' ? JSON.parse : function (data) {
           if (typeof data === 'string') {
               ...
               avalon$1.error('Invalid JSON: ' + data)
           }
           return data
       }


       avalon$1.fn.attr = function (name, value) {
       ...
       avalon$1.cssNumber = avalon$1.oneObject('animationIterationCount,columnCount,order,flex,flexGrow,flexShrink,fillOpacity,fontWeight,lineHeight,opacity,orphans,widows,zIndex,zoom')
       var prefixes = ['', '-webkit-', '-o-', '-moz-', '-ms-']

       avalon$1.cssName = function (name, host, camelCase) {
           if (cssMap[name]) {
               return cssMap[name]
           }
           host = host || avalon$1.root.style || {}
           for (var i = 0, n = prefixes.length; i < n; i++) {
               camelCase = avalon$1.camelize(prefixes[i] + name)
       ...
       avalon$1.fn.css = function (name, value) {
           if (avalon$1.isPlainObject(name)) {
               for (var i in name) {
                   avalon$1.css(this, i, name[i])
               }
           } else {
               var ret = avalon$1.css(this, name, value)
           }
           return ret !== void 0 ? ret : this
       }

       avalon$1.fn.position = function () {
           ...
           if (this.css('position') === 'fixed') {
               ...
               parentOffset.top += avalon$1.css(offsetParent[0], 'borderTopWidth', true)
               parentOffset.left += avalon$1.css(offsetParent[0], 'borderLeftWidth', true)
           ...
           return {
               top: offset.top - parentOffset.top - avalon$1.css(elem, 'marginTop', true),
               left: offset.left - parentOffset.left - avalon$1.css(elem, 'marginLeft', true)
           }
       }

       avalon$1.fn.offsetParent = function () {
           var offsetParent = this[0].offsetParent
           while (offsetParent && avalon$1.css(offsetParent, 'position') === 'static') {
               offsetParent = offsetParent.offsetParent
           }
           return avalon$1(offsetParent || avalon$1.root)
       }
       ...
       'top,left'.replace(avalon$1.rword, function (name) {
           cssHooks[name + ':get'] = function (node) {
               var computed = cssHooks['@:get'](node, name)
               return /px$/.test(computed) ? computed :
                   avalon$1(node).position()[name] + 'px'
           }
       })
       ...
       avalon$1.each({
           ...
           cssHooks[method + ':get'] = function (node, which, override) {
               ...
               if (boxSizing === 2) { // margin-box 2
                   return ret + avalon$1.css(node, 'margin' + which[0], true) + avalon$1.css(node, 'margin' + which[1], true)
               }
               if (boxSizing < 0) { // padding-box  -2
                   ret = ret - avalon$1.css(node, 'border' + which[0] + 'Width', true) - avalon$1.css(node, 'border' + which[1] + 'Width', true)
               }
               if (boxSizing === -4) { // content-box -4
                   ret = ret - avalon$1.css(node, 'padding' + which[0], true) - avalon$1.css(node, 'padding' + which[1], true)
               }
               return ret
           }
           ...
           avalon$1.fn[method] = function (value) { //会忽视其display
               var node = this[0]
           ...
           avalon$1.fn['inner' + name] = function () {
               return cssHooks[method + ':get'](this[0], void 0, -2)
           }
           avalon$1.fn['outer' + name] = function (includeMargin) {
       ...
       avalon$1.fn.offset = function () { //取得距离页面左右角的坐标
           var node = this[0],
               box = {
                   left: 0,
                   top: 0
           ...
           if (!avalon$1.contains(root, node)) {
               return box
           }
       ...
       avalon$1.each({
           ...
           avalon$1.fn[method] = function (val) {
               var node = this[0] || {}
               ...
               if (!arguments.length) {
                   ...
                   if (win) {
                       win.scrollTo(!top ? val : avalon$1(win).scrollLeft(), top ? val : avalon$1(win).scrollTop())
                   } else {
                       node[method] = val
                   }
               }
       ...
       var valHooks = {
           'option:get': avalon$1.msie ? function (node) {
       ...
       avalon$1.fn.val = function (value) {
           var node = this[0]
           if (node && node.nodeType === 1) {
       ...
       avalon$1.parseHTML = function (html) {
           var fragment = avalon$1.avalonFragment.cloneNode(false)
           //处理非字符串
           ...
           if (hasCache) {
               return avalon$1.cloneNode(hasCache)
           }
           var vnodes = avalon$1.lexer(html)
           for (var i = 0, el; el = vnodes[i++]; ) {
               fragment.appendChild(avalon$1.vdom(el, 'toDOM'))
           }
           if (html.length < 1024) {
       ...
       avalon$1.innerHTML = function (node, html) {
       ...
       avalon$1.unescapeHTML = function (html) {
           return String(html)
                   .replace(/&quot;/g, '"')
                   .replace(/&#39;/g, '\'')
                   .replace(/&lt;/g, '<')
       ...
       avalon$1.clearHTML = function (node) {
           node.textContent = ''
           /* istanbul ignore next */
       ...
       var hackSafari = avalon$1.modern && doc.ontouchstart

       //添加fn.bind, fn.unbind, bind, unbind
       avalon$1.fn.bind = function (type, fn, phase) {
           if (this[0]) { //此方法不会链
               return avalon$1.bind(this[0], type, fn, phase)
           }
       }

       avalon$1.fn.unbind = function (type, fn, phase) {
           if (this[0]) {
               avalon$1.unbind(this[0], type, fn, phase)
           }
           return this
       }

       /*绑定事件*/
       avalon$1.bind = function (elem, type, fn) {
           if (elem.nodeType === 1) {
               ...
               if (type === 'click' && hackSafari) {
                   elem.addEventListener('click', avalon$1.noop)
               }
               if (hook) {
                   type = hook.type || type
                   if (hook.fix) {
               ...
               var key = type + ':' + uuid
               avalon$1.eventListeners[fn.uuid] = fn
               if (value.indexOf(type + ':') === -1) {//同一种事件只绑定一次
                   if (canBubbleUp[type] || (avalon$1.modern && focusBlur[type])) {
                       delegateEvent(type)
                   } else {
                       avalon$1._nativeBind(elem, type, dispatch)
                   }
               }
               ...
               avalon$1._nativeBind(elem, type, fn)
           }
           return fn //兼容之前的版本
       }

       avalon$1.unbind = function (elem, type, fn) {
           if (elem.nodeType === 1) {
               var value = elem.getAttribute('avalon-events') || ''
               switch (arguments.length) {
                   case 1:
                       avalon$1._nativeUnBind(elem, type, dispatch)
                   ...
                   default:
                       ...
                       elem.setAttribute('avalon-events', value)
                       delete avalon$1.eventListeners[fn.uuid]
                       break
               }
           } else {
               avalon$1._nativeUnBind(elem, type, fn)
           }
       }
       ...
       function dispatch(event) {
           ...
           while ((handler = handlers[i++]) && !event.cancelBubble) {
               ...
               while ((uuid = handler.uuids[j++])) {
                   ...
                   var fn = avalon$1.eventListeners[uuid]
                   if (fn) {
                       var vm = rhandleHasVm.test(uuid) ? handler.elem._ms_context_ : 0
                       if (vm && vm.$hashcode === false) {
                           return avalon$1.unbind(elem, type, fn)
                       }
       ...
       function delegateEvent(type) {
           ...
           if (value.indexOf(type) === -1) {
               var arr = value.match(avalon$1.rword) || []
               arr.push(type)
               root.setAttribute('delegate-events', arr.join(','))
               avalon$1._nativeBind(root, type, dispatch, !!focusBlur[type])
           }
       }
       ...
       avalon$1._nativeBind = W3C ? function (el, type, fn, capture) {
           el.addEventListener(type, fn, capture)
       } : function (el, type, fn) {
           el.attachEvent('on' + type, fn)
       }

       avalon$1._nativeUnBind = W3C ? function (el, type, fn) {
           el.removeEventListener(type, fn)
       } : function (el, type, fn) {
           el.detachEvent('on' + type, fn)
       }

       avalon$1.fireDom = function (elem, type, opts) {
           /* istanbul ignore else */
           if (doc.createEvent) {
               var hackEvent = doc.createEvent('Events')
               hackEvent.initEvent(type, true, true, opts)
               avalon$1.shadowCopy(hackEvent, opts)
       ...
       var keyMap = avalon$1.oneObject("break,case,catch,continue,debugger,default,delete,do,else,false," +
       ...
       var pool = avalon$1.evaluatorPool
       var brackets = /\(([^)]*)\)/
       var rshortCircuit = /\|\|/g
       var rpipeline = /\|(?=\?\?)/
       ...
       function parseExpr$1(binding) {
               ...
               if (filters.length) {
                       filters = filters.map(function (filter) {
                               ...
                               var arg = '[' + avalon$1.quote(filter.trim()) + bracketArgs + ']'
                               return arg
       ...
       avalon$1.composeFilters = function () {
               var args = arguments
               return function (value) {
                       for (var i = 0, arr; arr = args[i++];) {
                               var name = arr[0]
                               var filter = avalon$1.filters[name]
       ...
       function extLocal(ret) {
               var arr = []
               for (var i in ret) {
                       arr.push('var ' + i + ' = __local__[' + avalon$1.quote(i) + ']')
               }
               return arr
       }
       ...
       function quoteError(str, type) {
               return '\tavalon.warn(e, ' +
                       avalon$1.quote('parse ' + type + ' binding【 ' + str + ' 】fail')
                       + ')'
       }

       var rbinding = /^(\:|ms\-)\w+/
       var eventMap = avalon$1.oneObject('animationend,blur,change,input,click,dblclick,focus,keydown,keypress,keyup,mousedown,mouseenter,mouseleave,mousemove,mouseout,mouseover,mouseup,scan,scroll,submit')
       ...
       function serializeChildren(children, skip, binding) {
           ...
           switch (node.nodeName) {
               case '#text':
                   if (!skip && config.rexpr.test(node.nodeValue)) {
                       ...
                       return '{nodeName:"#text",\ndynamic:{},\nnodeValue:' + avalon$1.parseExpr(binding) + '}'
                   } else {
                       return jsonfy(node)
                   }
               case '#comment':
       ...
       function serializeFor(vdom) {
           ...
           avalon$1.directives['for'].parse(copy, vdom, avalon$1.mix({
               type: 'for',
               name: 'ms-for'
           },vdom.dynamic))
           //为copy添加dynamic
       ...
       function serializeLogic(vdom) {
           ...
           if (match && match[1]) {
               ...
               avalon$1.warn(nodeValue + ' parse fail!')
           }
           return jsonfy(vdom)
       }
       ...
       function render(vtree, local) {
           ...
           try {
               ...
               avalon$1.warn(_body, 'render parse error')
           }
           return fn
       }
       ...
       avalon$1.scan = function (a) {
           /* istanbul ignore if */
           if (!a || !a.nodeType) {
               avalon$1.warn('[avalon.scan] first argument must be element , documentFragment, or document')
               return
           }
           scanNodes([a])
       }
       avalon$1._hydrate = variantByDom
       ...
       function scanNodes(nodes) {
           for (var i = 0, elem; elem = nodes[i++];) {
               if (elem.nodeType === 1) {
                   ...
                   var vm = avalon$1.vmodels[$id]
                   if (vm && !vm.$element) {
                       vm.$element = elem
                       /* istanbul ignore if */
                       if (avalon$1.serverTemplates && avalon$1.serverTemplates[$id]) {
                           var tmpl = avalon$1.serverTemplates[$id]
                           var oldTree = avalon$1.speedUp(tmpl)
                           var render = avalon$1.render(oldTree)
                           var vtree = render(vm)
                           var dom = avalon$1.vdom(vtree[0], 'toDOM')
                           vm.$element = dom
                           dom.vtree = vtree
                           vm.$render = render
                           elem.parentNode.replaceChild(dom, elem)
                           avalon$1.diff(vtree, vtree)
                           continue
                       }
                       ...
                       collectDeps(vtree[0])
                       var now2 = new Date()
                       onceWarn && avalon$1.log('构建虚拟DOM耗时', now2 - now, 'ms')

                       vm.$render = avalon$1.render(elem.vtree)
                       avalon$1.scopes[vm.$id] = {
                           vmodel: vm,
                           local: {},
                           isTemp: true
                       }
                       ...
                       if (onceWarn && (now3 - now2 > 100)) {
                           avalon$1.log('构建当前vm的$render方法耗时 ', now3 - now2, 'ms\n',
                               '如果此时间太长,达100ms以上\n',
                               '建议将当前ms-controller拆分成多个ms-controller,减少每个vm管辖的区域')
                           onceWarn = false
                       }
                       avalon$1.rerenderStart = now3
                       //  avalon.batch($id)
                       ...
                       bs.forEach(function (b) {
                           switch (b.type) {
                               ...
                               case 'text':
                                   ...
                                   avalon$1.directives.text.parse({}, node, b)
                                   var dom = b.dom
                                   if (dom) {
       ...
       avalon$1.ready(function () {
           avalon$1.scan(doc.body)
       })

       new function () {
           if (!avalon$1.inBrowser)
               return
           ...
           avalon$1.bind(win, 'load', fireReady)
       }
       ...
       function $watch(expr, callback) {
           ...
           avalon$1.Array.ensure(list, callback)

           return function () {
               avalon$1.Array.remove(list, callback)
           }
       }
       ...
       var $$skipArray = avalon$1.oneObject('$id,$render,$track,$element,$watch,$fire,$events,$skipArray,$accessors,$hashcode,$run,$wait,__proxy__,__data__,__const__')
       ...
       warlords.isSkip  = function (key, value, skipArray) {
           ...
           return key.charAt(0) === '$' ||
                   skipArray[key] ||
                   (rskip.test(avalon$1.type(value))) ||
       ...
       function batchUpdateView(id) {
           avalon$1.rerenderStart = new Date
           var dotIndex = id.indexOf('.')
           if (dotIndex > 0) {
               avalon$1.batch(id.slice(0, dotIndex))
           } else {
               avalon$1.batch(id)
           }
       }
       ...
       avalon$1.define = function (definition) {
           var $id = definition.$id
           if (!$id) {
               avalon$1.warn('vm.$id must be specified')
           }
           if (avalon$1.vmodels[$id]) {
       ...
       function arrayFactory(array, old, heirloom, options) {
           if (old && old.splice) {
               ...
               ++avalon$1.suspendUpdate
               avalon$1.callArray =  options.pathname
       ...
       //                }
               ...
               var hashcode = avalon$1.makeHashCode('$')
               options.array = true
       ...
       function emitArray(sid, vm, spath, val, older) {
           if (sid.indexOf('.*.') > 0) {
               ...
               var top = avalon$1.vmodels[ arr[1] ]
               if (top) {
                   var path = arr[2]
       ...
       function emitWildcard(obj, vm, spath, val, older) {
           if (obj.__fuzzy__) {
               obj.__fuzzy__.replace(avalon$1.rword, function (expr) {
                   var list = obj[expr]
                   var reg = list.reg
       ...
       /* istanbul ignore if*/
       if (!canHideProperty) {
           if ('__defineGetter__' in avalon$1) {
           ...
           if (avalon$1.msie < 9) {
               ...
               defineProperties = function (name, accessors, properties) {
                   ...
                   if (!className) {
                       className = avalon$1.makeHashCode('VBClass')
       ...
       var makeHashCode = avalon$1.makeHashCode
       ...
       function masterFactory(definition, heirloom, options) {
           ...
           if (definition.$skipArray) {//收集所有不可监听属性
               $skipArray = avalon$1.oneObject(definition.$skipArray)
       ...
       function mediatorFactory(before, after) {
           ...
           var heirloom = {}
           var arr = avalon$1.slice(arguments)
           var $skipArray = {}
           ...
           for (var i = 0; i < arr.length; i++) {
               ...
               for (var key in obj) {
                   ...
                   keys[key] = cur
                   if (accessors[key] && avalon$1.isObject(cur)) {//处理子vm
       ...
       avalon$1.mediatorFactory = mediatorFactory

       function update(vdom, update, hookName) {
           if (hookName) {
               vdom.afterChange = vdom.afterChange || []
               avalon$1.Array.ensure(vdom.afterChange, update)
           } else {
               var dom = vdom.dom
       ...
       avalon$1.directive('important', {
           ...
           update: function (dom, vdom, parent) {
               avalon$1.directives.controller.update(dom, vdom, parent, 'important')
           }
       })

       var cacheMediator = {}
       avalon$1.mediatorFactoryCache = function (top, $id) {
           var vm = avalon$1.vmodels[$id]
           if (vm && top && vm !== top) {
               var a = top.$hashcode
               var b = vm.$hashcode
               ...
               var c = avalon$1.mediatorFactory(top, vm)
               return cacheMediator[id] = c
           } else {
               return top
           }
       }
       avalon$1.directive('controller', {
           priority: 2,
           parse: function (copy, src, binding) {
               var id = binding.expr = binding.expr.trim()
               var quoted = quote(id)
           ...
           update: function (dom, vdom, parent, important) {
               ...
               var scope = avalon$1.scopes[id]
               if (scope) {
                   return
               }

               var top = avalon$1.vmodels[id]
               if (vmodel.$element && vmodel.$element.vtree[0] === vdom) {
                   var render = vmodel.$render
               } else {
                   render = avalon$1.render([vdom], local)
               }
               ...
               update(vdom, function () {
                   avalon$1(dom).removeClass('ms-controller')
                   dom.setAttribute('wid', id)
                   if(avalon$1._disposeComponent)
                   avalon$1._disposeComponent(dom)
       ...
       var cssDir = avalon$1.directive('css', {
           diff: function (copy, src, name) {
               var a = copy[name]
               var p = src[name]
               if (Object(a) === a) {
       ...
       avalon$1.parseDisplay = parseDisplay

       avalon$1.directive('visible', {
           diff: function (copy, src, name) {
               var c = !!copy[name]
           ...
           update: function (dom, vdom) {
               if (dom && dom.nodeType === 1) {
                   ...
                   if (show) {
                       ...
                       if (dom.style.display === '' && avalon$1(dom).css('display') === none &&
                           // fix firefox BUG,必须挂到页面上
                           avalon$1.contains(dom.ownerDocument, dom)) {
       ...
       avalon$1.directive('html', {
           parse: function (copy, src, binding) {
               if (!src.isVoidTag) {
                   //将渲染函数的某一部分存起来,渲在c方法中转换为函数
                   copy[binding.name] = avalon$1.parseExpr(binding)
                   copy.vmodel = '__vmodel__'
                   copy.local = '__local__'
               } else {
                   copy.children = '[]'
           ...
           diff: function (copy, src, name) {
               ...
               if (!src.dynamic['ms-html'] || !src.render || copyValue !== src[name]) {
                   ...
                   var oldTree = avalon$1.lexer(copyValue)
                   var render = avalon$1.render(oldTree, copy.local)
                   src.render = render
           ...
           update: function (dom, vdom) {
               ...
               avalon$1.clearHTML(dom)
               dom.appendChild(avalon$1.domize(vdom.children))
           }
       })
           ...
           update: function (dom, vdom) {
               ...
               if (classEvent) {
                   for (var i in classEvent) {
                       if (i === 'tabIndex') {
                           ...
                           avalon$1.bind(dom, i, classEvent[i])
                       }
                   }
                   vdom.classEvent = {}
               }
               ...
               names.forEach(function (type) {
                   ...
                   if (type === 'class') {
                       ...
                       if (oldType) {
                           avalon$1(dom).removeClass(oldType)
                       }
       ...
       function activateClass(e) {
           var elem = e.target
           avalon$1(elem).addClass(elem.getAttribute(classMap[e.type]) || '')
       }

       function abandonClass(e) {
           var elem = e.target
           var name = classMap[e.type]
           avalon$1(elem).removeClass(elem.getAttribute(name) || '')
           if (name !== 'change-active') {
               avalon$1(elem).removeClass(elem.getAttribute('change-active') || '')
           }
       }
       ...
       function setClass(dom, vdom) {
           ...
           if (old !== neo) {
               avalon$1(dom).removeClass(old).addClass(neo)
       ...
       avalon$1.directive('on', {
           ...
           diff: function (copy, src, name) {
               ...
               if (!src.dynamic[name] || srcFn.uuid !== uuid) {
                   src[name] = fn
                   avalon$1.eventListeners[uuid] = fn
                   hasChange = true
               }
               ...
               if (dom && dom.nodeType === 1) { //在循环绑定中，这里为null
                   ...
                   for (key in vdom) {
                       ...
                       if (match) {
                           listener = vdom[key]
                           vdom.dynamic[key] = 1
                           avalon$1.bind(dom, match[1], listener)
                       }
                   }
               }
           }
       ...
       var updateModelMethods = {
           ...
           checkbox: function () {
               ...
               if (!Array.isArray(array)) {
                   avalon$1.warn('ms-duplex应用于checkbox上要对应一个数组')
                   array = [array]
               }
           ...
           select: function () {
               var data = this
               var val = avalon$1(data.dom).val() //字符串或字符串数组
               if (val + '' !== this.value + '') {
       ...
       function updateModelByEvent(node, vnode) {
           ...
           for (var name in events) {
               avalon$1.bind(node, name, events[name])
           }
       }
           ...
           if (rules && !field.validator) {
               while (node && node.nodeType === 1) {
                   ...
                   if (validator) {
                       ...
                       if (avalon$1.Array.ensure(validator.fields, field)) {
       ...
       avalon$1.directive('duplex', {
           ...
           parse: function (copy, src, binding) {
               ...
               var get = avalon$1.parseExpr(binding)// 输出原始数据
               var quoted = parsers.map(function (a) {
                   return avalon$1.quote(a)
               })
               copy[duplexDir] = stringify({
                   type: dtype, //这个决定绑定什么事件
                   vmodel: '__vmodel__',
                   local: '__local__',
                   debug: avalon$1.quote(binding.name + '=' + binding.expr),
                   isChecked: isChecked,
                   parsers: '[' + quoted + ']',
                   isString: !!isString,
                   ...
                   get: get,
                   set: avalon$1.evaluatorPool.get('duplex:set:' + expr),
                   callback: changed ? avalon$1.parseExpr({ expr: changed, type: 'on' }) : 'avalon.noop'
               })
           ...
           update: function (dom, vdom) {
               if (dom && dom.nodeType === 1) {
                   ...
                   if (!dom.__ms_duplex__) {
                       dom.__ms_duplex__ = avalon$1.mix(vdom[duplexDir], { dom: dom })
                       //绑定事件
                   ...
                   if (data.isString
                       ...
                       var intervalID = setInterval(function () {
                           if (!avalon$1.contains(avalon$1.root, dom)) {
       ...
       var valiDir = avalon$1.directive('validate', {
           //验证单个表单元素
           diff: function (copy, src, name) {
           ...
           update: function (dom, vdom) {
               ...
               if (validator.validateAllInSubmit) {
                   avalon$1.bind(dom, 'submit', function (e) {
                       e.preventDefault()
                       onManual()
                   })
               }
           ...
           addField: function (field) {
               ...
               if (validator.validateInKeyup && (!field.isChanged && !field.debounceTime)) {
                   avalon$1.bind(node, 'keyup', function (e) {
                       valiDir.validate(field, 0, e)
                   })
               }
               /* istanbul ignore if */
               if (validator.validateInBlur) {
                   avalon$1.bind(node, 'blur', function (e) {
                       valiDir.validate(field, 0, e)
                   })
               }
               /* istanbul ignore if */
               if (validator.resetInFocus) {
                   avalon$1.bind(node, 'focus', function (e) {
           ...
           validate: function (field, isValidateAll, event) {
               ...
               if (typeof Promise !== 'function') {
                   avalon$1.error('please npm install avalon-promise or bluebird')
               }
               /* istanbul ignore if */
               if (elem.disabled)
                   return
               ...
               if (!(rules.norequired && value === '')) {
                   for (var ruleName in rules) {
                       ...
                       if (ruleValue === false)
                           continue
                       var hook = avalon$1.validators[ruleName]
                       var resolve, reject
       ...
       valiDir.defaults = {
           ...
           onError: avalon$1.noop,
           onSuccess: avalon$1.noop,
           onComplete: avalon$1.noop,
           onManual: avalon$1.noop,
           onReset: avalon$1.noop,
           onValidateAll: avalon$1.noop,
       ...
       function isRegExp(value) {
           return avalon$1.type(value) === 'regexp'
       }
       ...
       avalon$1.shadowCopy(avalon$1.validators, {
           pattern: {
           ...
           equalto: {
               ...
               get: function (value, field, next) {
                   ...
                   var other = avalon$1(document.getElementById(id)).val() || ""
                   next(value === other)
                   return value
               }
           },
       ...
       avalon$1._each = function (obj, fn, local) {

           var arr = (fn + '').slice(0, 40).match(rargs$1)
           arr.shift()
           if (Array.isArray(obj)) {
               for (var i = 0; i < obj.length; i++) {
                   iterator$1(i, obj[i], local, fn, arr[0], arr[1], true)
               }
           } else {
               for (var i in obj) {
                   if (obj.hasOwnProperty(i)) {
                       iterator$1(i, obj[i], local, fn, arr[0], arr[1])
                   }
               }
           }
       }

       function iterator$1(index, item, vars, fn, k1, k2, isArray) {
       ...
       avalon$1.directive('for', {
           priority: 3,
           parse: function (copy, src, binding) {
               var getLoop = avalon$1.parseExpr(binding)
               /**
                *  var vnodes = []
               ...
               var renderBody = [
                   ...
                   '     index   : arguments[0],',
                   '     children: new function(){',
                   '        var vnodes = ' + avalon$1.caches[src.signature],
                   '        vnodes.push({',
                   '           nodeName: "#comment",',
                   '           nodeValue:' + quote(src.signature),
                   '        })',
           ...
           diff: function (copy, src, name) {
               ...
               if (!src.list || !src.list.length) {//一维数组最开始初始化时
                   ...
                   for (var i in cache) {
                       p = cache[i]
                       p.action = 'leave'
                       avalon$1.Array.remove(srcRepeat, p)
                       removes.push(p)
                       if (p.arr) {
               ...
               src.removes = removes
               var cb = avalon$1.caches[src.wid]
               var vm = copy.vmodel
               if (end && cb) {
           ...
           update: function (dom, vdom, parent) {
               ...
               vdom.list.forEach(function (el, i) {
                   if (el.action === 'leave')
                       return
                   if (!el.dom) {
                       el.dom = avalon$1.domize(el)
                   }
                   var f = el.dom
                   if (el.oldIndex === void 0) {
                       if (hasEffect)
                           var nodes = avalon$1.slice(f.childNodes)
       ...
       var applyEffects = function (nodes, vnodes, opts) {
           vnodes.forEach(function (vdom, i) {
               avalon$1.applyEffect(nodes[i], vdom, opts)
           })
       }
       ...
       var support = effectDetect(
           avalon$1.cssName('transition-duration'),
           avalon$1.cssName('animation-duration'),
           avalon$1.window
       )

       avalon$1.directive('effect', {
           priority: 5,
           diff: function (copy, src, name) {
              ...
              var is = copy[name]
               if (typeof is === 'string') {
                   ...
                   avalon$1.warn('ms-effect的指令值不再支持字符串,必须是一个对象')
               }
           ...
           update: function (dom, vdom, parent, opts) {
              /* istanbul ignore if */
               if (dom && dom.nodeType === 1) {
                   ...
                   /* istanbul ignore if */
                   if (!type) {//如果没有指定类型
                       return avalon$1.warn('need is option')
                   }
                   var effects = avalon$1.effects
                   /* istanbul ignore if */
                   if (support.css && !effects[type]) {
                       avalon$1.effect(type)
                   }
                   var globalOption = effects[type]
                   /* istanbul ignore if */
                   if (!globalOption) {//如果没有定义特效
                       return avalon$1.warn(type + ' effect is undefined')
                   }
                   var finalOption = {}
                   ...
                   var Effect = avalon$1.Effect
                   /* istanbul ignore if */

                   var effect = new Effect(dom)
                   avalon$1.mix(finalOption, globalOption, option)
       ...
       avalon$1.effect = function (name, opts) {
           var definition = avalon$1.effects[name] = (opts || {})
           ...
           return function (option) {
               ...
               var animationDone = function (e) {
                   ...
                   if (--elem.__ms_effect_ === 0) {
                       avalon$1.unbind(elem, support.transitionEndEvent)
                       avalon$1.unbind(elem, support.animationEndEvent)
                   }
               ...
               if (option[lower]) {
                   ...
                   setTimeout(function () {
                       isAnimateDone = avalon$1.root.offsetWidth === NaN
       ...
       avalon$1.applyEffect = function (node, vnode, opts) {
           var cb = opts.cb
           ...
           if (curEffect && node && node.nodeType === 1) {
               ...
               getAction(opts)
               avalon$1.directives.effect.update(node, vnode, 0, avalon$1.shadowCopy({}, opts))
       ...
       var specialTag = avalon$1.oneObject('script,style,textarea,xmp,noscript,option,template')
           ...
           do {
               ...
               if (!node) {
                   ...
                   if (match) {
                       ...
                       /* istanbul ignore else*/
                       if (!last) {
                           avalon$1.error(match[0] + '前面缺少<' + nodeName + '>')
                       } else if (last.nodeName !== nodeName) {
                           avalon$1.error(last.nodeName + '没有闭合')
                       }
                       node = stack.pop()
                       node.end = true
                       str = str.slice(match[0].length)
       ...
       function nomalString(str) {
           return avalon$1.unescapeHTML(str.replace(rfill, fill))
       }
       ...
       function diffProps(copy, source) {
           try {
               for (var name in copy) {
                   var match = name.match(rbinding$1)
               ...
               avalon$1.warn(type, e, e.stack || e.message, 'diffProps error')
           }
       }
       ...
       avalon$1.suspendUpdate = 0

       function batchUpdate(id) {
               return
           if (renderingID) {
               return avalon$1.Array.ensure(needRenderIds, id)
           } else {
               renderingID = id
           }
           var scope = avalon$1.scopes[id]
           if (!scope || !document.nodeName || avalon$1.suspendUpdate) {
           ...
           if (scope.isTemp) {
               ...
               delete avalon$1.scopes[id]
           }

           avalon$1.diff(copy, source)
       ...
       avalon$1.lexer = variantByText
       avalon$1.diff = diff
       avalon$1.batch = batchUpdate
       avalon$1.speedUp = variantCommon
       avalon$1.parseExpr = parseExpr$1
       avalon$1.render = render

       var legalTags = { wbr: 1, xmp: 1, template: 1 }
       var events = 'onInit,onReady,onViewChange,onDispose'
       var componentEvents = avalon$1.oneObject(events)
       ...
       function initComponent(src, rawOption, local, template) {
           ...
           var definition = avalon$1.components[is]
           ...
           if (!id && onceWarn$1) {
               avalon$1.warn('warning!', is, '组件最好在ms-widget配置对象中指定全局不重复的$id以提高性能!\n',
           ...
           if (hooks.define) {
               delete hooks.define
               avalon$1.warn('warning! 组件的define配置项已经被废掉')
           }
           var define = avalon$1.directives.widget.define
           //生成组件VM
           var $id = id || src.props.id || 'w' + (new Date - 0)
           var defaults = avalon$1.mix(true, {}, definition.defaults)
           ...
           var shell = avalon$1.lexer(template)
         ...
         //  avalon.speedUp(shell)
           ...
           var render = avalon$1.render(shell, local)
           ...
           var vtree = avalon$1.lexer(finalTemplate)

           if (vtree.length > 1) {
               avalon$1.error('组件必须用一个元素包起来')
           }
           var soleSlot = definition.soleSlot
           replaceSlot(vtree, soleSlot)
           avalon$1.speedUp(vtree)

           var render2 = avalon$1.render(vtree)

           //生成最终的组件渲染函数
           var str = fnTemplate + ''
           var zzzzz = soleSlot ? avalon$1.quote(soleSlot) : "null"
           str = str.
       ...
       function fnTemplate() {
           ...
           for (var i in shellRoot) {
               if (i !== 'children' && i !== 'nodeName') {
                   if (i === 'props') {
                       avalon$1.mix(component.props, shellRoot.props)
                   } else {
           ...
           var soleSlot = ZZZZZ
           var slots = avalon$1.collectSlots(shellRoot, soleSlot)
           ...
           avalon$1.insertSlots(vtree, slots)
       ...
       avalon$1.insertSlots = function (vtree, slots) {
           for (var i = 0, el; el = vtree[i]; i++) {
               if (el.nodeName === '#comment' && slots[el.type]) {
                   ...
                   avalon$1.insertSlots(el.children, slots)
               }
           }
       }

       avalon$1.collectSlots = function (node, soleSlot) {
           var slots = {}
           if (soleSlot) {
       ...
       function isCustomTag(type) {
           return rcustomTag.test(type) || avalon$1.components[type]
       }
       ...
       function fireDisposeHook(el) {
           if (el.nodeType === 1 && el.getAttribute('wid') && !inDomTree(el)) {
               ...
               var docker = avalon$1.scopes[wid]

               if (!docker)
                   return
               var elemID = el.getAttribute('ms-controller') || el.getAttribute('ms-important')
               var vm = elemID && avalon$1.vmodels[elemID] || docker.vmodel
               vm.$fire("onDispose", {
                   type: 'dispose',
                   target: el,
                   vmodel: vm
       ...
       function byRewritePrototype() {
           ...
           function newSetter(html) {
               var all = avalon$1.slice(this.getElementsByTagName('*'))
       ...
       function byPolling(dom) {
           avalon$1.Array.ensure(checkDisposeNodes, dom)
           if (!checkID) {
               checkID = setInterval(function () {
                   for (var i = 0, el; el = checkDisposeNodes[i];) {
                       if (false === fireDisposeHook(el)) {
                           avalon$1.Array.removeAt(checkDisposeNodes, i)
                       } else {
                           i++
                       }
                   }
       ...
       avalon$1._disposeComponent = disposeComponent

       avalon$1.component = function (name, definition) {
           //这是定义组件的分支,并将列队中的同类型对象移除
           /* istanbul ignore if */
           if (!avalon$1.components[name]) {
               avalon$1.components[name] = definition
           }//这里没有返回值
       }
       avalon$1.directive('widget', {
           priority: 4,
           parse: function (copy, src, binding) {
               src.props.wid = src.props.wid || avalon$1.makeHashCode('w')
               //将渲染函数的某一部分存起来,渲在c方法中转换为函数
               copy[binding.name] = avalon$1.parseExpr(binding)
           ...
           define: function () {
               return avalon$1.mediatorFactory.apply(this, arguments)
           },
           diff: function (copy, src, name, copyList, srcList, index) {
               ...
               if (Object(a) === a) {
                   ...
                   var scope = avalon$1.scopes[comVm.$id]
           ...
           mountComponent: function (dom, vdom, parent) {
               delete vdom.dom
               var com = avalon$1.vdom(vdom, 'toDOM')
               ...
               com.vtree = [vdom]
               avalon$1._disposeComponent(com)
               ...
               update(vdom, function () {
                   vdom['component-html:' + is] = avalon$1.vdom(vdom, 'toHTML')
               }, 'afterChange')
           }
       })
       ...
       function viewChangeHandle(dom, vdom) {
           ...
           var curHTML = avalon$1.vdom(vdom, 'toHTML')
           if (preHTML !== curHTML) {
               vdom[html] = curHTML
