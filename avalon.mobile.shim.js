/*==================================================
 ...
 avalon.mobile.shim.js(去掉加载器与domReady) 1.391 build in 2015.1.29 
...
new function() {
        ...
        function touchend(event) {
            ...
            if (totalX > 30 || totalY > 30) {
                ...
                if (fastclick.canClick(element) && touchProxy.mx < 30 && touchProxy.my < 30) {
                    // 失去焦点的处理
        ...
        document.addEventListener(touchNames[1], function(event) {
            ...
            if (touchProxy.tapping && (touchProxy.mx > 30 || touchProxy.my > 30)) {
                touchProxy.element = null
            }
        })
