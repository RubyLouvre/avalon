...
define(["avalon"], function (avalon) {
    ...
    avalon.ui.wtabs = function (element, data, vmodels) {
        ...
        //4 构建组建的ViewModel
        var vmodel = avalon.define(data.wtabsid, function (vm) {
