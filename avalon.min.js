(function(r){function A(){}function B(b){s.console&&avalon.config.debug&&console.log(v?b:b+"")}function T(b,c){"string"===typeof b&&(b=b.match(C)||[]);for(var d={},e=void 0!==c?c:1,f=0,g=b.length;f<g;f++)d[b[f]]=e;return d}function Xa(){return"avalon"+Math.random().toString(36).substring(2,15)+Math.random().toString(36).substring(2,15)}function Ya(b){return Ob.test(Za.call(b))}function sa(b,c){b=Math.floor(b)||0;return 0>b?Math.max(c+b,0):Math.min(b,c)}function J(b,c,d){if(Array.isArray(b)){var e=
b.concat();b.length=0;b=Pb(b);b.push.apply(b,e);return b}if("number"===typeof b.nodeType)return b;var f={};c=c||{};var g={},h={},e=[],k=avalon.mix({},d||{}),l=b.$skipArray;d=0;for(var m;m=Qb[d++];)delete b[m],h[m]=!0;if(Array.isArray(l))for(d=0;m=l[d++];)"string"!==typeof m&&B("warning:$skipArray["+m+"] must be a string"),h[m]=!0;for(d in b)Rb(d,b[d],c,h,g,e,k);f=ia(f,Sb(g),h);for(m in h)f[m]=h[m];k.vmodel=f;f.$model=c;f.$events={};f.$id=Xa();f.$accessors=g;f[y]=[];for(d in K)b=K[d],v||(b=b.bind(f)),
f[d]=b;f.hasOwnProperty=function(b){return b in f.$model};for(d=0;b=e[d++];)U[x]=b,b(),ja(b),delete U[x];return f}function Rb(b,c,d,e,f,g,h){d[b]=c;if(e[b]||c&&c.nodeType||"$"===b.charAt(0)&&!h[b])return e[b]=c;var k=avalon.type(c);if("function"===k)return e[b]=c;var l,m;if("object"===k&&"function"===typeof c.get&&2>=Object.keys(c).length){var n=c.set,p=c.get;l=function(c){var e=h.vmodel,f=d[b];if(arguments.length){if(!ma){if("function"===typeof n){var g=e.$events[b];e.$events[b]=[];n.call(e,c);e.$events[b]=
g}if(!Z(m,c)){m=c;c=d[b]=p.call(e);if(na&&(g=V[e.$id])&&g[b])g[b].$val=c;D(l);e.$events&&K.$fire.call(e,b,c,f)}}}else return avalon.openComputedCollect&&ja(l),c=d[b]=p.call(e),Z(f,c)||(m=void 0,e.$events&&K.$fire.call(e,b,c,f)),c};g.push(l)}else ta.test(k)?(l=function(c){var e=l.$vmodel,f=e.$model;if(arguments.length){if(!ma&&!Z(f,c)){c=l.$vmodel=Ub(e,c,k);var g=ua[c.$id];g&&g();g=h.vmodel;d[b]=c.$model;D(e);g.$events&&K.$fire.call(g,b,d[b],f)}}else return ja(e),e},l.$vmodel=c.$model?c:J(c,c),d[b]=
l.$vmodel.$model):(l=function(c){var e=d[b];if(arguments.length){if(!Z(e,c)){d[b]=c;var f=h.vmodel;if(na){var g=V[f.$id];g&&g[b]&&(g[b].$val=c)}D(l);f.$events&&K.$fire.call(f,b,c,e)}}else return ja(l),e},d[b]=c);l[y]=[];f[b]=l}function Ub(b,c,d){if("array"===d){if(!Array.isArray(c))return b;c=c.concat();b.clear();b.push.apply(b,c);return b}var e=b[y]||[];V[b.$id]&&(na--,delete V[b.$id]);var f=J(c);ua[f.$id]=function(b){for(;b=e.shift();)(function(b){b.type&&avalon.nextTick(function(){b.rollback&&
b.rollback();E[b.type](b,b.vmodels)})})(b);delete ua[f.$id]};return f}function $(b,c,d){b="for(var "+b+"i=0,n = this.length; i < n; i++){"+c.replace("_","((i in this) && fn.call(scope,this[i],i,this))")+"}"+d;return Function("fn,scope",b)}function $a(b,c){if(c)for(;c=c.parentNode;)if(c===b)return!0;return!1}function ab(){return(new XMLSerializer).serializeToString(this)}function u(b){for(var c in b)if(P.call(b,c)){var d=b[c];if("function"===typeof u.plugins[c])u.plugins[c](d);else"object"===typeof u[c]?
avalon.mix(u[c],d):u[c]=d}return this}function bb(b){return b.replace(/([a-z\d])([A-Z]+)/g,"$1-$2").toLowerCase()}function oa(b){return 0>b.indexOf("-")&&0>b.indexOf("_")?b:b.replace(/[-_][^-_]/g,function(b){return b.charAt(1).toUpperCase()})}function cb(b){if(!("classList"in b)){b.classList={node:b};for(var c in db)b.classList[c.slice(1)]=db[c]}return b.classList}function eb(b){try{b="true"===b?!0:"false"===b?!1:"null"===b?null:+b+""===b?+b:Vb.test(b)?avalon.parseJSON(b):b}catch(c){}return b}function fb(b,
c){if(0>=b.offsetWidth){if(Wb.test(w["@:get"](b,"display"))){var d={node:b},e;for(e in gb)d[e]=b.style[e],b.style[e]=gb[e];c.push(d)}(d=b.parentNode)&&1===d.nodeType&&fb(d,c)}}function va(b,c){U[x]=b;avalon.openComputedCollect=!0;var d=b.evaluator;if(d)try{var e=Xb.test(b.type)?b:d.apply(0,b.args);b.handler(e,b.element,b)}catch(f){delete b.evaluator,3===b.nodeType&&(u.commentInterpolate?b.element.replaceChild(r.createComment(b.value),b.node):b.node.data=L+b.value+M),B("warning:evaluator of ["+b.value+
...
l=!0}else if("if"===g.type||null===g.node)l=!0;if(l)d.splice(f,1),g.proxies&&(wa(g.proxies),g.proxies=g.callbackElement=g.template=g.startRepeat=g.endRepeat=null),B("debug: remove "+g.type),g.element=g.node=g.evaluator=null;else if(!0!==c)if("function"===typeof g)g.apply(0,e);else if(g.getter)g.handler.apply(g,e);else if(g.node||g.element)g.handler((g.evaluator||A).apply(0,g.args||[]),h,g)}}function hb(b,c){var d=NaN,e=setInterval(function(){var f=b.innerHTML;f===d?(clearInterval(e),c()):d=f},Yb)}
function pa(b,c,d){d=b.getAttribute(xa+"skip");if(!b.getAttributeNode)return B("warning "+b.tagName+" no getAttributeNode method");var e=b.getAttributeNode(xa+"important"),f=b.getAttributeNode(xa+"controller");if("string"!==typeof d){if(d=e||f){f=X[d.value];if(!f)return;c=d===e?[f]:[f].concat(c);e=d.name;b.removeAttribute(e);b.setAttribute("avalonctrl",d.value);f.$events.expr=b.tagName+'[avalonctrl="'+d.value+'"]';avalon(b).removeClass(e)}ib(b,c)}}function ya(b,c){for(var d=b.firstChild;d;){var e=
d.nextSibling,f=d.nodeType;1===f?pa(d,c):3===f&&ba.test(d.data)?jb(d,c):u.commentInterpolate&&(8===f&&!ba.test(d.nodeValue))&&jb(d,c);d=e}}function jb(b,c){var d=[];if(8===b.nodeType){var e=[],f={expr:!0,value:kb(b.nodeValue,e)};e.length&&(f.filters=e);e=[f]}else e=za(b.data);if(e.length){for(var g=0;f=e[g++];){var h=r.createTextNode(f.value);if(f.expr){var k=f.filters,f={type:"text",node:h,nodeType:3,value:f.value,filters:k};k&&-1!==k.indexOf("html")&&(avalon.Array.remove(k,"html"),f.type="html",
f.replaceNodes=[h],k.length||delete d.filters);d.push(f)}Q.appendChild(h)}b.parentNode.replaceChild(Q,b);d.length&&Aa(d,c)}}function Zb(b,c){return b.priority-c.priority}function ib(b,c){for(var d=lb?lb(b):avalon.slice(b.attributes),e=[],f={},g,h=0,k;k=d[h++];)if(k.specified&&(g=k.name.match(mb))){var l=g[1],m=g[2]||"",n=k.value;k=k.name;f[k]=n;$b[l]?(m=l,l="on"):"enabled"===l&&(l="disabled",n="!("+n+")");if("checked"===l||"selected"===l||"disabled"===l||"readonly"===l)m=l,l="attr",b.removeAttribute(k),
k="ms-attr-"+m,b.setAttribute(k,n),g=[k],f[k]=n;"function"===typeof E[l]&&(n={type:l,param:m,element:b,name:g[0],value:n,priority:l in nb?nb[l]:10*l.charCodeAt(0)+(Number(m)||0)},"if"===l&&-1<m.indexOf("loop")&&(n.priority+=100),c.length&&(e.push(n),"widget"===l&&(b.msData=b.msData||f)))}e.sort(Zb);f["ms-checked"]&&f["ms-duplex"]&&B("warning!\u4e00\u4e2a\u5143\u7d20\u4e0a\u4e0d\u80fd\u540c\u65f6\u5b9a\u4e49ms-checked\u4e0ems-duplex");d=e[0]||{};switch(d.type){case "if":case "repeat":case "widget":Aa([d],
c);break;default:Aa(e,c),!ac[b.tagName]&&Ba.test(b.innerHTML.replace(ob,"<").replace(pb,">"))&&ya(b,c)}if(b.patchRepeat){b.patchRepeat();try{b.patchRepeat="",b.removeAttribute("patchRepeat"),b.removeAttribute("avalonctrl")}catch(p){}}}function Aa(b,c){for(var d=0,e;e=b[d++];)e.vmodels=c,E[e.type](e,c),e.evaluator&&e.name&&e.element.removeAttribute(e.name);b.length=0}function kb(b,c){0<b.indexOf("|")&&(b=b.replace(bc,"U2hvcnRDaXJjdWl0"),b=b.replace(cc,function(b,e,f){c.push(e+(f||""));return""}),b=
...
l.concat("'use strict';\n"+n+b)),d.evaluator=Da(g,c)}catch(la){B("debug: parse error,"+la.message)}finally{h=e=l=null}}}function N(b,c,d,e){Array.isArray(e)&&(b=e.map(function(b){return b.expr?"("+b.value+")":ic(b.value)}).join(" + "));qa(b,c,d);d.evaluator&&(d.handler=Ea[d.handlerName||d.type],d.evaluator.toString=function(){return d.type+" binding to eval("+b+")"},va(d))}function ca(b,c){var d="_"+b;if(!ca[d]){var e=r.createElement(b);z.appendChild(e);c=v?getComputedStyle(e,null).display:e.currentStyle.display;
z.removeChild(e);ca[d]=c}return ca[d]}function rb(b,c,d){var e=r.createEvent("Events");e.initEvent(c,!0,!0);d&&(e.detail=d);b.dispatchEvent(e)}function jc(){!this.disabled&&this.oldValue!==this.value&&(v?rb(this,"input"):this.fireEvent("onchange"))}function kc(){for(var b=da.length-1;0<=b;b--)!1===(0,da[b])()&&da.splice(b,1);da.length||clearInterval(sb)}function lc(b){mc.call(this,b);b!==this.oldValue&&rb(this,"input")}function nc(b){var c={},d;for(d in b)c[d]=b[d];d=c.target=b.srcElement;0===b.type.indexOf("key")?
c.which=null!=b.charCode?b.charCode:b.keyCode:/mouse|click/.test(b.type)&&(d=d.ownerDocument||r,d="BackCompat"===d.compatMode?d.body:d.documentElement,c.pageX=b.clientX+(d.scrollLeft>>0)-(d.clientLeft>>0),c.pageY=b.clientY+(d.scrollTop>>0)-(d.clientTop>>0),c.wheelDeltaY=c.wheelDelta,c.wheelDeltaX=0);c.timeStamp=new Date-0;c.originalEvent=b;c.preventDefault=function(){b.returnValue=!1};c.stopPropagation=function(){b.cancelBubble=!0};return c}function Pb(b){var c=[];c.$id=Xa();c[y]=[];c.$model=b;c.$events=
{};c._=J({length:b.length});c._.$watch("length",function(b,d){c.$fire("length",b,d)});for(var d in K)c[d]=K[d];avalon.mix(c,tb);return c}function Fa(b){var c=[];ub(b,c);for(var d=0,e;e=c[d++];)"ms-if"===e.nodeValue&&O.appendChild(e.elem);for(;e=b.firstChild;)O.appendChild(e);O.innerHTML=""}function oc(b,c){var d=ea(this.callbackElement,this.callbackName,this.vmodels);d&&hb(c,function(){d.apply(c,b)})}function vb(b){function c(b,e){for(var f=b.childNodes,g=0,h;h=f[g++];)1===h.nodeType&&(e.push(h),
...
c),this):this[0].getAttribute(b)},data:function(b,c){b="data-"+bb(b||"");switch(arguments.length){case 2:return this.attr(b,c),this;case 1:var d=this.attr(b);return eb(d);case 0:var e={};I.forEach.call(this[0].attributes,function(c){c&&(b=c.name,b.indexOf("data-")||(b=oa(b.slice(5)),e[b]=eb(c.value)))});return e}},removeData:function(b){b="data-"+bb(b);this[0].removeAttribute(b);return this},css:function(b,c){if(avalon.isPlainObject(b))for(var d in b)avalon.css(this,d,b[d]);else var e=avalon.css(this,
...
this[0]||{},f=e.window&&e.document?e:9===e.nodeType?e.defaultView||e.parentWindow:!1,g="scrollTop"===b;if(arguments.length)f?f.scrollTo(!g?d:avalon(f).scrollLeft(),g?d:avalon(f).scrollTop()):e[b]=d;else return f?c in f?f[c]:z[b]:e[b]}});var w=avalon.cssHooks={},Ib=["","-webkit-","-o-","-moz-","-ms-"],La={"float":"cssFloat",background:"backgroundColor"};avalon.cssNumber=T("columnCount,order,fillOpacity,fontWeight,lineHeight,opacity,orphans,widows,zIndex,zoom");avalon.cssName=function(b,c,d){if(La[b])return La[b];
c=c||z.style;for(var e=0,f=Ib.length;e<f;e++)if(d=oa(Ib[e]+b),d in c)return La[b]=d;return null};w["@:set"]=function(b,c,d){try{b.style[c]=d}catch(e){}};if(s.getComputedStyle)w["@:get"]=function(b,c){if(!b||!b.style)throw Error("getComputedStyle\u8981\u6c42\u4f20\u5165\u4e00\u4e2a\u8282\u70b9 "+b);var d,e=getComputedStyle(b,null);e&&(d="filter"===c?e.getPropertyValue(c):e[c],""===d&&(d=b.style[c]));return d},w["opacity:get"]=function(b){b=w["@:get"](b,"opacity");return""===b?"1":b};else{var Fc=/^-?(?:\d*\.)?\d+(?!px)[^\d\s]+$/i,
Gc=/^(top|right|bottom|left)$/,Ma=!!s.XDomainRequest,Hc={thin:Ma?"1px":"2px",medium:Ma?"3px":"4px",thick:Ma?"5px":"6px"};w["@:get"]=function(b,c){var d=b.currentStyle,e=d[c];if(Fc.test(e)&&!Gc.test(e)){var f=b.style,g=f.left,h=b.runtimeStyle.left;b.runtimeStyle.left=d.left;f.left="fontSize"===c?"1em":e||0;e=f.pixelLeft+"px";f.left=g;b.runtimeStyle.left=h}"medium"===e&&(c=c.replace("Width","Style"),"none"===d[c]&&(e="0px"));return""===e?"auto":Hc[e]||e};w["opacity:set"]=function(b,c,d){b.style.filter=
"alpha(opacity="+100*d+")";b.style.zoom=1};w["opacity:get"]=function(b){b=b.filters.alpha||b.filters["DXImageTransform.Microsoft.Alpha"];return(b?b.opacity:100)/100+""}}"top,left".replace(C,function(b){w[b+":get"]=function(c){var d=w["@:get"](c,b);return/px$/.test(d)?d:avalon(c).position()[b]+"px"}});var gb={position:"absolute",visibility:"hidden",display:"block"},Wb=/^(none|table(?!-c[ea]).+)/;"Width,Height".replace(C,function(b){var c=b.toLowerCase(),d="client"+b,e="scroll"+b,f="offset"+b;w[c+":get"]=
function(c,d,e){var l=-4;"number"===typeof e&&(l=e);d="Width"===b?["Left","Right"]:["Top","Bottom"];e=c[f];if(2===l)return e+avalon.css(c,"margin"+d[0],!0)+avalon.css(c,"margin"+d[1],!0);0>l&&(e=e-avalon.css(c,"border"+d[0]+"Width",!0)-avalon.css(c,"border"+d[1]+"Width",!0));-4===l&&(e=e-avalon.css(c,"padding"+d[0],!0)-avalon.css(c,"padding"+d[1],!0));return e};w[c+"&get"]=function(b){var d=[];fb(b,d);for(var e=w[c+":get"](b),f=0,m;m=d[f++];){b=m.node;for(var n in m)"string"===typeof m[n]&&(b.style[n]=
...
this.parseHTML(c);this.clearHTML(b).appendChild(e)};avalon.clearHTML=function(b){Fa(b);return b};var K={$watch:function(b,c){if("function"===typeof c){var d=this.$events[b];d?d.push(c):this.$events[b]=[c]}else this.$events=this.$watch.backup;return this},$unwatch:function(b,c){var d=arguments.length;if(0===d)this.$watch.backup=this.$events,this.$events={};else if(1===d)this.$events[b]=[];else for(var d=this.$events[b]||[],e=d.length;0>~--e;)if(d[e]===c)return d.splice(e,1);return this},$fire:function(b){var c;
...
H.firstChild);var Zc=/<noscript.*?>(?:[\s\S]+?)<\/noscript>/img,$c=/<noscript.*?>([\s\S]+?)<\/noscript>/im,Qa=function(){return new (s.XMLHttpRequest||ActiveXObject)("Microsoft.XMLHTTP")},ea=function(b,c,d){if(b=b.getAttribute(c)){c=0;for(var e;e=d[c++];)if(e.hasOwnProperty(b)&&"function"===typeof e[b])return e[b]}},Ra=avalon.templateCache={},W=r.createElement("div");W.innerHTML="a";try{W.contains(W.firstChild),avalon.contains=function(b,c){return b.contains(c)}}catch(kd){avalon.contains=$a}var Sa=
...
s.VBArray&&!g&&(wb(c)?g=!0:Cb.test(c)||(g=(g=(c.attributes||{})[f])?!1===g.expando:null===g));g?c[f]=b:c.setAttribute(f,b)}else if("include"===e&&b){var h=d.vmodels,k=ea(c,"data-include-rendered",h),l=ea(c,"data-include-loaded",h),m=function(b){l&&(b=l.apply(c,[b].concat(h)));avalon.innerHTML(c,b);ya(c,h);k&&hb(c,function(){k.call(c)})};if("src"===d.param)if(Ra[b])avalon.nextTick(function(){m(Ra[b])});else{var n=Qa();n.onreadystatechange=function(){if(4===n.readyState){var c=n.status;if(200<=c&&300>
c||304===c||1223===c)m(Ra[b]=n.responseText)}};n.open("GET",b,!0);"withCredentials"in n&&(n.withCredentials=!0);n.setRequestHeader("X-Requested-With","XMLHttpRequest");n.send(null)}else{var p=b&&1===b.nodeType?b:r.getElementById(b);if(p){if("NOSCRIPT"===p.tagName&&!p.innerHTML&&!p.fixIE78){n=Qa();n.open("GET",location,!1);n.send(null);f=r.getElementsByTagName("noscript");g=(n.responseText||"").match(Zc)||[];d=g.length;for(e=0;e<d;e++){var q=f[e];q&&(q.style.display="none",q.fixIE78=(g[e].match($c)||
...
c,d){if(b){var e=this.group,f=this.startRepeat?this.startRepeat.parentNode:this.callbackElement,g=this.proxies,h=Q.cloneNode(!1);if("del"===b||"move"===b)var k=Ga(f,this,c);switch(b){case "add":for(var l=d,m=this.getter().length-1,e=[],n={},k=0,p=l.length;k<p;k++){var n=k+c,q=sc(n,l[k],this,m);g.splice(n,0,q);n=xb(this,h,e,q)}k=Ga(f,this,c);n.node=k;n.parent=f;f.insertBefore(h,k);for(k=0;n=e[k++];)pa(n,this.vmodels);break;case "del":h=g.splice(c,d);wa(h);Fa(yb(k,e,d));break;case "index":for(m=g.length-
1;d=g[c];c++)d.$index=c,d.$first=0===c,d.$last=c===m;break;case "clear":if(this.startRepeat)for(;;)if((n=this.startRepeat.nextSibling)&&n!==this.endRepeat)h.appendChild(n);else break;else h=f;wa(g);Fa(h);break;case "move":if(h=g.splice(c,1)[0])g.splice(d,0,h),h=yb(k,e),k=Ga(f,this,d),f.insertBefore(h,k);break;case "set":(q=g[c])&&(q[q.$itemName]=d);break;case "append":g=d;k=ea(this.callbackElement,"data-with-sorted",this.vmodels);m=[];e=[];n={};for(l in c)c.hasOwnProperty(l)&&"hasOwnProperty"!==l&&
m.push(l);k&&(k=k.call(f,m))&&(Array.isArray(k)&&k.length)&&(m=k);for(k=0;l=m[k++];)"hasOwnProperty"!==l&&(n=xb(this,h,e,g[l]));n.parent=f;n.node=this.endRepeat||null;f.insertBefore(h,n.node);for(k=0;d=e[k++];)pa(d,this.vmodels)}oc.call(this,arguments,f)}},html:function(b,c,d){b=null==b?"":b;c||(c=d.element=d.node.parentNode);if(d.replaceNodes){var e;if(11===b.nodeType)e=b;else if(1===b.nodeType||b.item){b=1===b.nodeType?b.childNodes:b.item?b:[];for(e=Q.cloneNode(!0);b[0];)e.appendChild(b[0])}else e=
...
c,d){b=null==b?"":b;var e=d.node;if(3===d.nodeType){d.element=e.parentNode;try{e.data=b}catch(f){}}else"textContent"in c?c.textContent=b:c.innerText=b},visible:function(b,c,d){c.style.display=b?d.display:"none"},widget:A},Lb=/\(([^)]*)\)/,ad=/^\s+$/;avalon.parseDisplay=ca;var E=avalon.bindingHandlers={attr:function(b,c){var d=b.value.trim(),e=!0;-1<d.indexOf(L)&&2<d.indexOf(M)&&(e=!1,ba.test(d)&&(""===RegExp.rightContext&&""===RegExp.leftContext)&&(e=!0,d=RegExp.$1));b.handlerName="attr";N(d,c,b,
e?null:za(b.value))},"class":function(b,c){var d=b.param,e=b.value;b.handlerName="class";if(!d||isFinite(d)){b.param="";var f=e.replace(Gb,function(b){return Math.pow(10,b.length-1)}).indexOf(":");if(-1===f)d=e;else if(d=e.slice(0,f),e=e.slice(f+1),qa(e,c,b),b.evaluator)b._evaluator=b.evaluator,b._args=b.args;else return B("debug: ms-class '"+(e||"").trim()+"' \u4e0d\u5b58\u5728\u4e8eVM\u4e2d"),!1;e=ba.test(d);e||(b.immobileClass=d);N("",c,b,e?za(d):null)}else b.immobileClass=b.oldStyle=b.param,N(e,
...
for(f=0;m=c[f++];)if(m.hasOwnProperty(g)&&m.hasOwnProperty(l)){b.$outer=m;break}l=h.firstChild;b.fastRepeat=!!l&&1===l.nodeType&&h.lastChild===l&&!l.attributes["ms-controller"]&&!l.attributes["ms-important"];e[y]&&e[y].push(b);D(e);if(!Array.isArray(e)&&"each"!==d){var p=V[e.$id];if(!p){na++;var p=V[e.$id]={},q;for(q in e)e.hasOwnProperty(q)&&"hasOwnProperty"!==q&&function(b,c){p[b]=rc(b,c,{});p[b].$watch("$val",function(c){e[b]=c})}(q,e[q])}b.handler("append",e,p)}else b.handler("add",0,e)}},html:function(b,
c){N(b.value,c,b)},"if":function(b,c){b.element.removeAttribute(b.name);b.placehoder||(b.msInDocument=b.placehoder=r.createComment("ms-if"));b.vmodels=c;N(b.value,c,b)},on:function(b,c){var d=b.value,e=b.param.replace(/-\d+$/,"");if("function"===typeof E.on[e+"Hook"])E.on[e+"Hook"](b);if(0<d.indexOf("(")&&-1<d.indexOf(")")&&(e=(d.match(Lb)||["",""])[1].trim(),""===e||"$event"===e))d=d.replace(Lb,"");N(d,c,b)},visible:function(b,c){var d=avalon(b.element),e=d.css("display");if("none"===e){var f=d[0].style,
...
n,h=n[f+"Id"];"string"===typeof h&&(d[1]=h)}h=avalon.getWidgetData(e,d[0]);b[f+"Id"]=d[1];b[f+"Options"]=avalon.mix({},g.defaults,n||{},h);e.removeAttribute("ms-widget");var p=g(e,b,c)||{};b.evaluator=A;e.msData["ms-widget-id"]=p.$id||"";p.hasOwnProperty("$init")&&p.$init();if(p.hasOwnProperty("$remove")){var q=function(){if(!e.msRetain&&!z.contains(e))return p.$remove(),e.msData={},delete X[p.$id],!1};s.chrome?e.addEventListener("DOMNodeRemovedFromDocument",function(){setTimeout(q)}):avalon.tick(q)}}else c.length&&
...
c(),d=null==d?"":d+"";d!==b.value&&(b.value=d)};"checkbox"===f&&"radio"===e&&(f="radio");if("radio"===f)d.handler=function(){b.defaultChecked=b.checked=/bool|text/.test(e)?c()+""===b.value:!!c()},q=function(){if(!1!==h.data("duplex-observe")){var d=b.value;"text"===e?c(d):"bool"===e?(d="true"===d,c(d)):(d=!b.defaultChecked,c(d),b.checked=d);m.call(b,d)}},g(e?"click":"mousedown",q);else if("checkbox"===f)q=function(){if(!1!==h.data("duplex-observe")){var d=b.checked?"ensure":"remove",e=c();if(Array.isArray(e))avalon.Array[d](e,
b.value);else avalon.error("ms-duplex\u4f4d\u4e8echeckbox\u65f6\u8981\u6c42\u5bf9\u5e94\u4e00\u4e2a\u6570\u7ec4");m.call(b,e)}},d.handler=function(){var d=[].concat(c());b.checked=0<=d.indexOf(b.value)},g(v?"change":"click",q);else if(f=b.attributes["data-duplex-event"]||b.attributes["data-event"]||{},f=f.value,"change"===f)g("change",q);else if(v&&9!==r.documentMode)g("input",q),g("compositionstart",n),g("compositionend",p);else{var ka=["keyup","paste","cut","change"],la=function(b){var c=b.keyCode;
91===c||(15<c&&19>c||37<=c&&40>=c)||("cut"===b.type?avalon.nextTick(q):q())};ka.forEach(function(c){b.attachEvent("on"+c,la)});d.rollback=function(){ka.forEach(function(c){b.detachEvent("on"+c,la)})}}b.oldValue=b.value;Mb(function(){if(avalon.contains(z,b))jc.call(b);else if(!b.msRetain)return!1});va(d);var Tb=setTimeout(function(){k||m.call(b,b.value);clearTimeout(Tb)},31)};var sb,da=[],Mb=A;avalon.tick=function(b){1===da.push(b)&&(sb=setInterval(kc,30))};try{var Ua=HTMLInputElement.prototype;Object.getOwnPropertyNames(Ua);
var mc=Object.getOwnPropertyDescriptor(Ua,"value").set;Object.defineProperty(Ua,"value",{set:lc})}catch(ld){Mb=avalon.tick}Y.SELECT=function(b,c,d){var e=avalon(b);d.handler=function(){var d=c(),d=d&&d.$model||d,d=Array.isArray(d)?d.map(String):d+"";d+""!==b.oldValue&&(e.val(d),b.oldValue=d+"")};d.bound("change",function(){if(!1!==e.data("duplex-observe")){var f=e.val();f+""!==b.oldValue&&(c(f),b.oldValue=f+"");d.changed.call(b,f)}});var f=NaN,g=setInterval(function(){var e=b.innerHTML;e===f?(clearInterval(g),
...
document.createElement("input")||(ha.input={type:"propertychange",deel:function(b,c){return function(d){if("value"===d.propertyName)return d.type="input",c.call(b,d)}}});if(void 0===document.onmousewheel){var Nb=void 0!==document.onwheel?"wheel":"DOMMouseScroll",bd="wheel"===Nb?"deltaY":"detail";ha.mousewheel={type:Nb,deel:function(b,c){return function(d){d.wheelDeltaY=d.wheelDelta=0<d[bd]?-120:120;d.wheelDeltaX=0;Object.defineProperty&&Object.defineProperty(d,"type",{value:"mousewheel"});c.call(b,
d)}}}}var Va=I.splice,tb={_splice:Va,_add:function(b,c){var d=this.length;c="number"===typeof c?c:d;for(var d=[],e=0,f=b.length;e<f;e++){var g=d,h=e,k=b[e];ta.test(avalon.type(k))&&(k=k.$id?k:J(k,k));g[h]=k}Va.apply(this,[c,0].concat(d));D(this,"add",c,d);if(!this._stopFireLength)return this._.length=this.length},_del:function(b,c){var d=this._splice(b,c);d.length&&(D(this,"del",b,c),this._stopFireLength||(this._.length=this.length));return d},push:function(){I.push.apply(this.$model,arguments);var b=
...
(0<=c?"+":"")+(b(Math[0<c?"floor":"ceil"](c/60),2)+b(Math.abs(c%60),2))}},g=/((?:[^yMdHhmsaZE']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z))(.*)/,h=/^\d+$/,k=/^(\d{4})-?(\d\d)-?(\d\d)(?:T(\d\d)(?::?(\d\d)(?::?(\d\d)(?:\.(\d+))?)?)?(Z|([+-])(\d\d):?(\d\d))?)?$/,l=/^(\d+)-(\d+)-(\d{4})$/,m=/^(\d+)\s+(\d+),(\d{4})$/;Wa.date=function(b,c){var d=Wa.date.locate,k="",n=[],Ta,ga;c=c||"mediumDate";c=d[c]||c;if("string"===typeof b){if(h.test(b))b=parseInt(b,10);else{ga=b.trim();if(ga.match(l)||ga.match(m))b=
RegExp.$3+"/"+RegExp.$1+"/"+RegExp.$2;b=e(b)}b=new Date(b)}"number"===typeof b&&(b=new Date(b));if("date"===avalon.type(b)){for(;c;)(ga=g.exec(c))?(n=n.concat(ga.slice(1)),c=n.pop()):(n.push(c),c=null);n.forEach(function(c){Ta=f[c];k+=Ta?Ta(b,d):c.replace(/(^'|'$)/g,"").replace(/''/g,"'")});return k}};var n={AMPMS:{"0":"\u4e0a\u5348",1:"\u4e0b\u5348"},DAY:{"0":"\u661f\u671f\u65e5",1:"\u661f\u671f\u4e00",2:"\u661f\u671f\u4e8c",3:"\u661f\u671f\u4e09",4:"\u661f\u671f\u56db",5:"\u661f\u671f\u4e94",6:"\u661f\u671f\u516d"},
...
delete g.delay;F.apply(null,h)};l?g.delay(l,h):m.push(g)};F.define.amd=t;F.config=u;F.checkDeps=e};var zb=[];"complete"===r.readyState?setTimeout(R):v?r.addEventListener("DOMContentLoaded",R):(r.attachEvent("onreadystatechange",function(){"complete"===r.readyState&&R()}),z.doScroll&&Ab());avalon.bind(s,"load",R);avalon.ready=function(b){F?F("ready!",b):R===A?b(avalon):zb.push(b)};avalon.config({loader:!0});avalon.ready(function(){if(s.VBArray&&!s.setImmediate){var b=[];avalon.nextTick=function(c){"function"===
