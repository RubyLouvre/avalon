...
c){for(var d=rb?rb(b):avalon.slice(b.attributes),e=[],f={},g,h=0,k;k=d[h++];)if(k.specified&&(g=k.name.match(sb))){var l=g[1],m=g[2]||"",n=k.value;k=k.name;f[k]=n;ec[l]?(m=l,l="on"):fc[l]&&(v("ms-"+l+"\u5df2\u7ecf\u88ab\u5e9f\u5f03,\u8bf7\u4f7f\u7528ms-attr-*\u4ee3\u66ff"),"enabled"===l&&(l="disabled",n="!("+n+")"),m=l,l="attr",b.removeAttribute(k),k="ms-attr-"+m,b.setAttribute(k,n),g=[k],f[k]=n);"function"===typeof C[l]&&(n={type:l,param:m,element:b,name:g[0],value:n,priority:l in tb?tb[l]:10*l.charCodeAt(0)+
(Number(m)||0)},"if"===l&&-1<m.indexOf("loop")&&(n.priority+=100),c.length&&(e.push(n),"widget"===l&&(b.msData=b.msData||f)))}e.sort(dc);f["ms-checked"]&&f["ms-duplex"]&&v("warning!\u4e00\u4e2a\u5143\u7d20\u4e0a\u4e0d\u80fd\u540c\u65f6\u5b9a\u4e49ms-checked\u4e0ems-duplex");d=e[0]||{};switch(d.type){case "if":case "repeat":case "widget":Ba([d],c);break;default:Ba(e,c),!gc[b.tagName]&&ub.test(b.innerHTML.replace(hc,"<").replace(ic,">"))&&nb(b,c)}}function Ba(b,c){b.length&&c.cb(b.length);for(var d=
...
$first:0===b,$last:b===e};b[f]=c;e=0;for(var h=da.length;e<h;e++)if(g=da[e],g.hasOwnProperty(f)&&avalon.type(g[f])===avalon.type(c)){for(var k in b)g[k]=b[k];da.splice(e,1);return g}va.test(avalon.type(c))&&(b.$skipArray=[f]);g=N(b,yc);g.$watch(f,function(b){d.$repeat.set(g.$index,b)});g.$id=("$proxy$"+d.type+Math.random()).replace(/0\./,"");return g}function Db(b){for(var c=0,d;d=b[c++];){var e=void 0;for(e in d.$events)Array.isArray(d.$events[e])&&(d.$events[e].length=0);da.unshift(d)>u.maxRepeatSize&&
da.pop()}b.length=0}function T(){p.body&&(D?(s["ready!"].state=2,D.checkDeps()):Eb.forEach(function(b){b(avalon)}),T=y)}function Fb(){try{B.doScroll("left"),T()}catch(b){setTimeout(Fb)}}var A=new Date-0,G="$"+A,r=Function("return this")(),zc=r.require,Ac=r.define,ja=!1,z=/[^, ]+/g,Gb=/\[native code\]/,va=/^(?:object|array)$/,Hb=/^\[object SVG\w*Element\]$/,Ub=/^\[object (?:Window|DOMWindow|global)\]$/,Ha=Object.prototype,O=Ha.hasOwnProperty,ia=Ha.toString,L=Array.prototype,$=L.slice,Y={},w=r.dispatchEvent,
...
Hc=Jb.length;Object.keys||(Object.keys=function(b){var c=[],d=Gc&&"function"===typeof b;if("string"===typeof b||b&&b.callee)for(d=0;d<b.length;++d)c.push(String(d));else for(var e in b)!(d&&"prototype"===e)&&O.call(b,e)&&c.push(String(e));if(Fc){d=(d=b.constructor)&&d.prototype===b;for(e=0;e<Hc;e++){var f=Jb[e];!(d&&"constructor"===f)&&O.call(b,f)&&c.push(f)}}return c});Array.isArray||(Array.isArray=function(b){return"[object Array]"===ia.call(b)});y.bind||(Function.prototype.bind=function(b){if(2>
...
[0,""]:[1,"X<div>"]};E.optgroup=E.option;E.tbody=E.tfoot=E.colgroup=E.caption=E.thead;E.th=E.td;"circle,defs,ellipse,image,line,path,polygon,polyline,rect,symbol,text,use".replace(z,function(b){E[b]=E.g});var Qc=/<([\w:]+)/,Rc=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,Pb=w?/[^\d\D]/:/(<(?:script|link|style|meta|noscript))/ig,Sc=M(["","text/javascript","text/ecmascript","application/ecmascript","application/javascript"]),Tc=/<(?:tb|td|tf|th|tr|col|opt|leg|cap|area)/,
Uc=p.createElement("script");avalon.parseHTML=function(b){"string"!==typeof b&&(b+="");b=b.replace(Rc,"<$1></$2>").trim();var c=(Qc.exec(b)||["",""])[1].toLowerCase(),d=E[c]||E._default,e=I.cloneNode(!1),f=ea,g;w||(b=b.replace(Pb,"<br class=msNoScope>$1"));f.innerHTML=d[1]+b+(d[2]||"");b=f.getElementsByTagName("script");if(b.length)for(var h=0,k;k=b[h++];)Sc[k.type]&&(g=Uc.cloneNode(!1),L.forEach.call(k.attributes,function(b){b&&b.specified&&(g[b.name]=b.value,g.setAttribute(b.name,b.value))}),g.text=
k.text,k.parentNode.replaceChild(g,k));for(h=d[0];h--;f=f.lastChild);if(!w){b=avalon.slice(f.getElementsByTagName("br"));for(h=0;k=b[h++];)k.className&&"msNoScope"===k.className&&k.parentNode.removeChild(k);b=f.all;for(h=0;k=b[h++];)fb(k)&&ac(k);if("tr"===c){b=avalon.slice(f.children);for(h=0;k=b[h++];)""==k.nodeName&&k.parentNode.removeChild(k)}}for(;c=f.firstChild;)e.appendChild(c);return e};avalon.innerHTML=function(b,c){if(!w&&!Pb.test(c)&&!Tc.test(c))try{b.innerHTML=c;return}catch(d){}var e=
this.parseHTML(c);this.clearHTML(b).appendChild(e)};avalon.clearHTML=function(b){for(b.textContent="";b.firstChild;)b.removeChild(b.firstChild);return b};var R={$watch:function(b,c){if("function"===typeof c){var d=this.$events[b];d?d.push(c):this.$events[b]=[c]}else this.$events=this.$watch.backup;return this},$unwatch:function(b,c){var d=arguments.length;if(0===d)this.$watch.backup=this.$events,this.$events={};else if(1===d)this.$events[b]=[];else for(var d=this.$events[b]||[],e=d.length;0>~--e;)if(d[e]===
c)return d.splice(e,1);return this},$fire:function(b){var c;/^(\w+)!(\S+)$/.test(b)&&(c=RegExp.$1,b=RegExp.$2);var d=this.$events,e=$.call(arguments,1),f=[b].concat(e);if("all"===c)for(var g in avalon.vmodels)e=avalon.vmodels[g],e!==this&&e.$fire.apply(e,f);else if("up"===c||"down"===c){if(d=d.expr&&Qb(d.expr)){for(g in avalon.vmodels)if(e=avalon.vmodels[g],e!==this&&e.$events.expr){var h=Qb(e.$events.expr);if(h&&("down"===c?d.contains(h):h.contains(d)))h._avalon=e}g=p.getElementsByTagName("*");var k=
[];Array.prototype.forEach.call(g,function(b){b._avalon&&(k.push(b._avalon),b._avalon="",b.removeAttribute("_avalon"))});"up"===c&&k.reverse();for(g=0;(c=k[g++])&&!1!==c.$fire.apply(c,f););}}else{f=d[b]||[];c=d.$all||[];for(g=0;d=f[g++];)V(d)&&d.apply(this,e);for(g=0;d=c[g++];)V(d)&&d.apply(this,arguments)}}},Vc=/(\w+)\[(avalonctrl)="(\S+)"\]/,Qb=p.querySelector?function(b){return p.querySelector(b)}:function(b){b=b.match(Vc);for(var c=p.getElementsByTagName(b[1]),d=0,e;e=c[d++];)if(e.getAttribute(b[2])===
b[3])return e},bc=/^(duplex|on)$/,S=[],ya=0,cc=200,ib=new Date,jb,Na={};avalon.scanCallback=function(b,c){c=c||"$all";(Na[c]||(Na[c]=[])).push(b)};avalon.scan=function(b,c,d){b=b||B;var e=Na[d||"$all"]||[];c=c?[].concat(c):[];var f=0,g=!1,h,k=!1;c.cb=function(b){f+=b;k=!0;setTimeout(function(){if(0>=f&&!g)for(g=!0;h=e.shift();)h()})};kb(b,c);if(!k)for(;h=e.shift();)h()};var gc=M("AREA,BASE,BASEFONT,BR,COL,COMMAND,EMBED,HR,IMG,INPUT,LINK,META,PARAM,SOURCE,TRACK,WBR,NOSCRIPT,SCRIPT,STYLE,TEXTAREA"),
sb=/ms-(\w+)-?(.*)/,tb={"if":10,repeat:90,data:100,widget:110,each:1400,"with":1500,duplex:2E3,on:3E3},ec=M("animationend,blur,change,input,click,dblclick,focus,keydown,keypress,keyup,mousedown,mouseenter,mouseleave,mousemove,mouseout,mouseover,mouseup,scan,scroll,submit"),fc=M("value,title,alt,checked,selected,disabled,readonly,enabled");if(!"1"[0])var Oa=Ca(512),Wc=/\s+(ms-[^=\s]+)(?:=("[^"]*"|'[^']*'|[^\s>]+))?/g,Xc=/^['"]/,Yc=/<\w+\b(?:(["'])[^"]*?(\1)|[^>])*>/i,Zc=/&amp;/g,rb=function(b){b=b.outerHTML;
if("</"===b.slice(0,2)||!b.trim())return[];b=b.match(Yc)[0];var c=[],d,e;if(Oa[b])return Oa[b];for(;d=Wc.exec(b);)(e=d[2])&&(e=(Xc.test(e)?e.slice(1,-1):e).replace(Zc,"&")),d=d[1].toLowerCase(),d.match(sb),c.push({name:d,specified:!0,value:e||""});return Oa(b,c)};var kc=/\|\s*(\w+)\s*(\([^)]*\))?/g,jc=/\|\|/g,lc=/U2hvcnRDaXJjdWl0/g,hc=/&lt;/g,ic=/&gt;/g,$c=/\/\*[\w\W]*?\*\/|\/\/[^\n]*\n|\/\/[^\n]*$|"(?:[^"\\]|\\[\w\W])*"|'(?:[^'\\]|\\[\w\W])*'|[\s\t\n]*\.[\s\t\n]*[$\w\.]+/g,ad=/[^\w$]+/g,bd=RegExp(""+
("\\b"+"break,case,catch,continue,debugger,default,delete,do,else,false,finally,for,function,if,in,instanceof,new,null,return,switch,this,throw,true,try,typeof,var,void,while,with,abstract,boolean,byte,char,class,const,double,enum,export,extends,final,float,goto,implements,import,int,interface,long,native,package,private,protected,public,short,static,super,synchronized,throws,transient,volatile,arguments,let,yield,undefined".replace(/,/g,"\\b|\\b")+"\\b"),"g"),cd=/\b\d[^,]*/g,dd=/^,+|,+$/g,Pa=Ca(512),
oc=function(b){var c=","+b.trim();if(Pa[c])return Pa[c];b=b.replace($c,"").replace(ad,",").replace(bd,"").replace(cd,"").replace(dd,"").split(/^$|,+/);return Pa(c,vb(b))},Da=Ca(128),pc=/\w\[.*\]|\w\.\w/,nc=/(\$proxy\$[a-z]+)\d+$/,ed={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},qc=r.JSON&&JSON.stringify||function(b){return'"'+b.replace(/[\\\"\x00-\x1f]/g,function(b){var d=ed[b];return"string"===typeof d?d:"\\u"+("0000"+b.charCodeAt(0).toString(16)).slice(-4)})+'"'};
avalon.parseExprProxy=K;var Qa={"accept-charset":"acceptCharset","char":"ch",charoff:"chOff","class":"className","for":"htmlFor","http-equiv":"httpEquiv"};"accessKey,bgColor,cellPadding,cellSpacing,codeBase,codeType,colSpan,dateTime,defaultValue,frameBorder,longDesc,maxLength,marginWidth,marginHeight,rowSpan,tabIndex,useMap,vSpace,valueType,vAlign".replace(z,function(b){Qa[b.toLowerCase()]=b});var pa=J.insertBefore(document.createElement("avalon"),J.firstChild);pa.innerHTML="X<style id='avalonStyle'>.avalonHide{ display: none!important }</style>";
...
c,d){d="data-"+d.param;b&&"object"===typeof b?c[d]=b:c.setAttribute(d,String(b))},repeat:function(b,c,d){if(b){var e=this.element.parentNode,f=this.proxies,g=I.cloneNode(!1);if("del"===b||"move"===b)var h=Ga(this,c);var k=this.group;switch(b){case "add":for(var l=d,m=this.$repeat.length-1,k=[],h=0,n=l.length;h<n;h++){var q=h+c,t=xc(q,l[h],this,m);f.splice(q,0,t);Ab(this,g,t,k)}h=Ga(this,c);e.insertBefore(g,h);for(h=0;g=k[h++];)za(g.nodes,g.vmodels),g.nodes=g.vmodels=null;Cb(this);break;case "del":f=
f.splice(c,d);g=Bb(h,k,d);avalon.clearHTML(g);Db(f);break;case "index":for(m=f.length-1;d=f[c];c++)d.$index=c,d.$first=0===c,d.$last=c===m;break;case "clear":for(;;)if((g=this.element.nextSibling)&&g!==this.endRepeat)e.removeChild(g);else break;Db(f);break;case "move":if(g=f.splice(c,1)[0])f.splice(d,0,g),g=Bb(h,k),h=Ga(this,d),e.insertBefore(g,h);break;case "set":(t=f[c])&&(t[t.$itemName]=d);break;case "append":f=d;m=[];k=[];for(l in c)c.hasOwnProperty(l)&&"hasOwnProperty"!==l&&m.push(l);this.sortedCallback&&
(h=this.sortedCallback.call(e,m))&&(Array.isArray(h)&&h.length)&&(m=h);for(h=0;l=m[h++];)"hasOwnProperty"!==l&&Ab(this,g,f[l],k);this.proxySize=m.length;e.insertBefore(g,this.element.nextSibling);for(h=0;g=k[h++];)za(g.nodes,g.vmodels),g.nodes=g.vmodels=null;Cb(this)}var H=this.renderedCallback||y,F=arguments;avalon.scanCallback(function(){H.apply(e,F);e.oldValue&&("SELECT"===e.tagName&&"index"===b)&&avalon(e).val(e.oldValue.split(","))});avalon.scan(e)}},html:function(b,c,d){b=null==b?"":b;var e=
...
e=!0;-1<d.indexOf(P)&&2<d.indexOf(Q)&&(e=!1,aa.test(d)&&(""===RegExp.rightContext&&""===RegExp.leftContext)&&(e=!0,d=RegExp.$1));if("include"===b.type){var f=b.element;b.includeRendered=fa(f,"data-include-rendered",c);b.includeLoaded=fa(f,"data-include-loaded",c);var g=b.includeReplaced=!!avalon(f).data("includeReplace");b.startInclude=p.createComment("ms-include");b.endInclude=p.createComment("ms-include-end");g?(b.element=b.startInclude,f.parentNode.insertBefore(b.startInclude,f),f.parentNode.insertBefore(b.endInclude,
f.nextSibling)):(f.insertBefore(b.startInclude,f.firstChild),f.appendChild(b.endInclude))}b.handlerName="attr";K(d,c,b,e?0:Aa(b.value))},"class":function(b,c){var d=b.param,e=b.value;b.handlerName="class";if(!d||isFinite(d)){b.param="";var f=e.replace(Lb,function(b){return Math.pow(10,b.length-1)}).indexOf(":");if(-1===f)d=e;else if(d=e.slice(0,f),e=e.slice(f+1),wb(e,c,b),b.evaluator)b._evaluator=b.evaluator,b._args=b.args;else return v("debug: ms-class '"+(e||"").trim()+"' \u4e0d\u5b58\u5728\u4e8eVM\u4e2d"),
!1;e=aa.test(d);e||(b.immobileClass=d);K("",c,b,e?Aa(d):0)}else b.immobileClass=b.oldStyle=b.param,K(e,c,b)},duplex:function(b,c){var d=b.element,e=d.tagName,f;K(b.value,c,b,0,1);if("function"===typeof X[e]&&(b.changed=fa(d,"data-duplex-changed",c)||y,b.evaluator&&b.args)){var g=[],h=M("string,number,boolean,checked");"radio"===d.type&&""===b.param&&(b.param="checked");b.param.replace(/\w+/g,function(c){/^(checkbox|radio)$/.test(d.type)&&/^(radio|checked)$/.test(c)&&("radio"===c&&v("ms-duplex-radio\u5df2\u7ecf\u66f4\u540d\u4e3ams-duplex-checked"),
...
typeof l[d]){var m=l[d],m=m.$model||m;break}m&&(k=m[f+"Id"],"string"===typeof k&&(g=k));k=avalon.getWidgetData(e,f);b.value=[f,g,d].join();b[f+"Id"]=g;b.evaluator=y;var n=b[f+"Options"]=avalon.mix({},h.defaults,m||{},k);e.removeAttribute("ms-widget");var q=h(e,b,c)||{};if(q.$id){if(avalon.vmodels[g]=q,lb(e,q),q.hasOwnProperty("$init")&&q.$init(function(){var b=[q].concat(c);b.cb=c.cb;avalon.scan(e,b);"function"===typeof n.onInit&&n.onInit.call(e,q,n,c)}),q.hasOwnProperty("$remove")){var p=function(){if(!e.msRetain&&
!B.contains(e))return q.$remove(),e.msData={},delete qa[q.$id],!1};r.chrome?e.addEventListener("DOMNodeRemovedFromDocument",function(){setTimeout(p)}):avalon.tick(p)}}else avalon.scan(e,c)}else c.length&&(e.vmodels=c)}};"hover,active".replace(z,function(b){C[b]=C["class"]});"with,each".replace(z,function(b){C[b]=C.repeat});C["if"]=C.data=C.text=C.html;"title,alt,src,value,css,include,href".replace(z,function(b){C[b]=C.attr});var X=C.duplex;avalon.duplexHooks={checked:{get:function(b,c){return!c.element.oldValue}},
string:{get:function(b){return b},set:Fa},"boolean":{get:function(b){return"true"===b},set:Fa},number:{get:function(b){return isFinite(b)?parseFloat(b)||0:b},set:Fa}};X.INPUT=function(b,c,d){function e(b){d.changed.call(this,b,d)}function f(){n=!0}function g(){n=!1}function h(){if(!n){var f=b.oldValue=b.value,f=d.pipe(f,d,"get");!1!==m.data("duplex-observe")&&(c(f),e.call(b,f),m.data("duplex-focus")&&avalon.nextTick(function(){b.focus()}))}}var k=b.type,l=d.bound,m=avalon(b),n=!1;d.handler=function(){var e=
...
(v("ms-duplex\u5e94\u7528\u4e8echeckbox\u4e0a\u8981\u5bf9\u5e94\u4e00\u4e2a\u6570\u7ec4"),g=[g]);avalon.Array[f](g,d.pipe(b.value,d,"get"));e.call(b,g)}},d.handler=function(){var e=[].concat(c());b.checked=0<=e.indexOf(d.pipe(b.value,d,"get"))},l(w?"change":"click",h);else{k=b.getAttribute("data-duplex-event")||b.getAttribute("data-event")||"input";b.attributes["data-event"]&&v("data-event\u6307\u4ee4\u5df2\u7ecf\u5e9f\u5f03\uff0c\u8bf7\u6539\u7528data-duplex-event");var t=function(b){setTimeout(function(){h(b)})};
k.replace(z,function(b){switch(b){case "input":w?(l("input",h),l("compositionstart",f),l("compositionend",g),9===p.documentMode&&(l("paste",t),l("cut",t))):l("propertychange",function(b){"value"===b.propertyName&&h()});break;default:l(b,h)}})}b.oldValue=b.value;Sb(function(){if(avalon.contains(B,b))xb.call(b);else if(!b.msRetain)return!1});xa(d);e.call(b,b.value)};var yb,ca=[],Sb=y;avalon.tick=function(b){1===ca.push(b)&&(yb=setInterval(sc,60))};try{var Ua=HTMLInputElement.prototype;Object.getOwnPropertyNames(Ua);
var uc=Object.getOwnPropertyDescriptor(Ua,"value").set;Object.defineProperty(Ua,"value",{set:tc})}catch(pd){Sb=avalon.tick}X.SELECT=function(b,c,d){var e=avalon(b);d.handler=function(){var d=c(),d=d&&d.$model||d;Array.isArray(d)?b.multiple||v("ms-duplex\u5728<select multiple=true>\u4e0a\u8981\u6c42\u5bf9\u5e94\u4e00\u4e2a\u6570\u7ec4"):b.multiple&&v("ms-duplex\u5728<select multiple=false>\u4e0d\u80fd\u5bf9\u5e94\u4e00\u4e2a\u6570\u7ec4");d=Array.isArray(d)?d.map(String):d+"";d+""!==b.oldValue&&(e.val(d),
b.oldValue=d+"")};d.bound("change",function(){if(!1!==e.data("duplex-observe")){var f=e.val(),f=Array.isArray(f)?f.map(function(b){return d.pipe(b,d,"get")}):d.pipe(f,d,"get");f+""!==b.oldValue&&c(f);d.changed.call(b,f,d)}});avalon.scanCallback(function(){xa(d);d.changed.call(b,c(),d)});avalon.scan(b)};X.TEXTAREA=X.INPUT;var ga=avalon.eventHooks;"onmouseenter"in B||avalon.each({mouseenter:"mouseover",mouseleave:"mouseout"},function(b,c){ga[b]={type:c,deel:function(c,e){return function(f){var g=f.relatedTarget;
if(!g||g!==c&&!(c.compareDocumentPosition(g)&16))return delete f.type,f.type=b,e.call(c,f)}}}});avalon.each({AnimationEvent:"animationend",WebKitAnimationEvent:"webkitAnimationEnd"},function(b,c){r[b]&&!ga.animationend&&(ga.animationend={type:c})});"oninput"in p.createElement("input")||(ga.input={type:"propertychange",deel:function(b,c){return function(d){if("value"===d.propertyName)return d.type="input",c.call(b,d)}}});if(void 0===p.onmousewheel){var Tb=void 0!==p.onwheel?"wheel":"DOMMouseScroll",
hd="wheel"===Tb?"deltaY":"detail";ga.mousewheel={type:Tb,deel:function(b,c){return function(d){d.wheelDeltaY=d.wheelDelta=0<d[hd]?-120:120;d.wheelDeltaX=0;Object.defineProperty&&Object.defineProperty(d,"type",{value:"mousewheel"});c.call(b,d)}}}}var Va=L.splice,zb={_splice:Va,_fire:function(b,c,d){ua(this.$events[G],b,c,d)},_add:function(b,c){var d=this.length;c="number"===typeof c?c:d;for(var d=[],e=0,f=b.length;e<f;e++){var g=d,h=e,k=b[e],l=this.$model[c+e];va.test(avalon.type(k))&&(k=k.$id?k:N(k,
0,l));g[h]=k}Va.apply(this,[c,0].concat(d));this._fire("add",c,d);if(!this._stopFireLength)return this._.length=this.length},_del:function(b,c){var d=this._splice(b,c);d.length&&(this._fire("del",b,c),this._stopFireLength||(this._.length=this.length));return d},push:function(){L.push.apply(this.$model,arguments);var b=this._add(arguments);this._fire("index",2<b?b-2:0);return b},pushArray:function(b){return this.push.apply(this,b)},unshift:function(){L.unshift.apply(this.$model,arguments);this._add(arguments,
...
ensure:function(b){this.contains(b)||this.push(b);return this},set:function(b,c){if(0<=b){var d=avalon.type(c);c&&c.$model&&(c=c.$model);var e=this[b];if("object"===d)for(var f in c)e.hasOwnProperty(f)&&(e[f]=c[f]);else"array"===d?e.clear().push.apply(e,c):e!==c&&(this[b]=c,this.$model[b]=c,this._fire("set",b,c))}return this}};"sort,reverse".replace(z,function(b){zb[b]=function(){var c=this.$model,d=c.slice(0),e=!1;L[b].apply(c,arguments);for(var f=0,g=d.length;f<g;f++){var h=c[f];if(!la(h,d[f])){var e=
!0,h=d.indexOf(h,f),k=this._splice(h,1)[0],l=d.splice(h,1)[0];this._splice(f,0,k);d.splice(f,0,l);this._fire("move",h,f)}}e&&this._fire("index",0);return this}});var yc=M("$index,$first,$last"),da=[],id=/<script[^>]*>([\S\s]*?)<\/script\s*>/gim,jd=/\s+(on[^=\s]+)(?:=("[^"]*"|'[^']*'|[^\s>]+))?/g,kd=/<\w+\b(?:(["'])[^"]*?(\1)|[^>])*>/ig,ld={a:/\b(href)\=("javascript[^"]*"|'javascript[^']*')/ig,img:/\b(src)\=("javascript[^"]*"|'javascript[^']*')/ig,form:/\b(action)\=("javascript[^"]*"|'javascript[^']*')/ig},
md=/[\uD800-\uDBFF][\uDC00-\uDFFF]/g,nd=/([^\#-~| |!])/g,Wa=avalon.filters={uppercase:function(b){return b.toUpperCase()},lowercase:function(b){return b.toLowerCase()},truncate:function(b,c,d){c=c||30;d=void 0===d?"...":d;return b.length>c?b.slice(0,c-d.length)+d:String(b)},camelize:oa,sanitize:function(b){return b.replace(id,"").replace(kd,function(b,d){var e=b.toLowerCase().match(/<(\w+)\s/);e&&(e=ld[e[1]])&&(b=b.replace(e,function(b,c,d){b=d.charAt(0);return c+"="+b+"javascript:void(0)"+b}));return b.replace(jd,
...
2:"3\u6708",3:"4\u6708",4:"5\u6708",5:"6\u6708",6:"7\u6708",7:"8\u6708",8:"9\u6708",9:"10\u6708",10:"11\u6708",11:"12\u6708"},SHORTDAY:{"0":"\u5468\u65e5",1:"\u5468\u4e00",2:"\u5468\u4e8c",3:"\u5468\u4e09",4:"\u5468\u56db",5:"\u5468\u4e94",6:"\u5468\u516d"},fullDate:"y\u5e74M\u6708d\u65e5EEEE",longDate:"y\u5e74M\u6708d\u65e5",medium:"yyyy-M-d ah:mm:ss",mediumDate:"yyyy-M-d",mediumTime:"ah:mm:ss","short":"yy-M-d ah:mm",shortDate:"yy-M-d",shortTime:"ah:mm"};m.SHORTMONTH=m.MONTH;Wa.date.locate=m};var s=
