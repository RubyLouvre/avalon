...
var t=function(b){setTimeout(function(){h(b)})};l.replace(z,function(b){switch(b){case "input":w?(k("input",h),k("compositionstart",f),k("compositionend",g),9===p.documentMode&&(k("paste",t),k("cut",t))):k("propertychange",function(b){"value"===b.propertyName&&h()});break;default:k(b,h)}})}b.oldValue=b.value;Tb(function(){if(avalon.contains(B,b))yb.call(b);else if(!b.msRetain)return!1});ya(d);e.call(b,b.value)};var zb,ca=[],Tb=y;avalon.tick=function(b){1===ca.push(b)&&(zb=setInterval(tc,60))};try{var Va=
