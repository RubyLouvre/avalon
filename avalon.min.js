...
b)}catch(e){console.log(c+""),v("warning:exception throwed in [registerSubscriber] "+e),delete b.evaluator,c=b.element,3===c.nodeType&&(d=c.parentNode,u.commentInterpolate?d.replaceChild(p.createComment(b.value),c):c.data=P+b.value+Q)}avalon.openComputedCollect=!1;delete Y[A]}function ka(b){var c=Y[A];b&&(c&&avalon.Array.ensure(b,c)&&c.element)&&hb(c,b)}function hb(b,c){b.$uuid=b.$uuid||ha();c.$uuid=c.$uuid||ha();var d={data:b,list:c,toString:function(){return b.$uuid+" "+c.$uuid}};S[d]||(S[d]=1,
S.push(d))}function ib(){for(var b=za,c=za+dc;b<c;b++){var d=S[b];if(!d)break;var e=d.data,f=e.element;if(null===f||(1===f.nodeType?"number"===typeof f.sourceIndex?0===f.sourceIndex:!B.contains(f):!avalon.contains(B,f))){S.splice(b,1);delete S[d];avalon.Array.remove(d.list,e);"if"===e.type&&(e.template&&e.template.parentNode===pa)&&pa.removeChild(e.template);for(var g in e)e[g]=null;d.data=d.list=null;b--;c--}}za=(d=S[b])?c:0;jb=new Date}function va(b){clearTimeout(kb);444<new Date-jb?ib():kb=setTimeout(ib,
444);if(b&&b.length)for(var c=$.call(arguments,1),d=b.length,e;e=b[--d];){var f=e.element;f&&f.parentNode&&(e.$repeat?e.handler.apply(e,c):"on"!==e.type&&e.handler((e.evaluator||y).apply(0,e.args||[]),f,e))}}function qa(b,c,d){var e=setTimeout(function(){var f=b.innerHTML;clearTimeout(e);f===d?c():qa(b,c,f)})}function lb(b,c,d){var e=b.getAttribute("ms-skip");if(!b.getAttributeNode)return v("warning "+b.tagName+" no getAttributeNode method");var f=b.getAttributeNode("ms-important");d=b.getAttributeNode("ms-controller");
if("string"!==typeof e){if(d=f||d){e=ra[d.value];if(!e)return;var g=c.cb;c=d===f?[e]:[e].concat(c);c.cb=g;f=d.name;b.removeAttribute(f);mb(b,e);avalon(b).removeClass(f)}nb(b,c)}}function mb(b,c){var d=b.getAttribute("avalonctrl")||c.$id;b.setAttribute("avalonctrl",d);c.$events.expr=b.tagName+'[avalonctrl="'+d+'"]'}function ob(b,c){for(var d=b.firstChild;d;){var e=d.nextSibling;pb(d,d.nodeType,c);d=e}}function Aa(b,c){for(var d=0,e;e=b[d++];)pb(e,e.nodeType,c)}function pb(b,c,d){1===c?lb(b,d):3===
c&&aa.test(b.data)?qb(b,d):u.commentInterpolate&&(8===c&&!aa.test(b.nodeValue))&&qb(b,d)}function qb(b,c){var d=[];if(8===b.nodeType){var e=[],f={expr:!0,value:rb(b.nodeValue,e)};e.length&&(f.filters=e);e=[f]}else e=Ba(b.data);if(e.length){for(var g=0;f=e[g++];){var h=p.createTextNode(f.value);if(f.expr){var k=f.filters,f={type:"text",element:h,value:f.value,filters:k};k&&-1!==k.indexOf("html")&&(avalon.Array.remove(k,"html"),f.type="html",f.group=1,k.length||delete d.filters);d.push(f)}I.appendChild(h)}b.parentNode.replaceChild(I,
...
"ig"),function(b){var d=b.charAt(c.length),e=/^\s*\(/.test(RegExp.rightContext);if("."===d||"["===d||e){d="var"+String(Math.random()).replace(/^0\./,"");if(e)return e=b.split("."),2<e.length?(b=e.pop(),k.push(d+" = "+e.join(".")),d+"."+b):b;k.push(d+" = "+b);return d}return b})}),f&&m.push(avalon.filters),d.args=m,c=Ea[g])d.evaluator=c;else{(n=k.join(", "))&&(n="var "+n);if(f){b="\nvar ret"+A+" = "+b;e=[];e.push(b,"\r\n");for(q=0;h=d.filters[q++];)m=h.indexOf("("),-1!==m?(f=h.slice(m+1,h.lastIndexOf(")")).trim(),
f=","+f,h=h.slice(0,m).trim()):f="",e.push(" if(filters",A,".",h,"){\n\ttry{\nret",A," = filters",A,".",h,"(ret",A,f,")\n\t}catch(e){} \n}\n");b=e.join("");b+="\nreturn ret"+A;l.push("filters"+A)}else{if("duplex"===e){n="'use strict';\nreturn function(vvv){\n\t"+n+";\n\tif(!arguments.length){\n\t\treturn "+b+"\n\t}\n\t"+(!qc.test(b)?h.get:b)+"= vvv;\n} ";try{c=Function.apply(y,l.concat(n)),d.evaluator=Ea(g,c)}catch(H){v("debug: parse error,"+H.message)}return}"on"===e?(b=-1===b.indexOf("(")?b+".call(this, $event)":
b.replace("(",".call(this,"),l.push("$event"),b="\nreturn "+b+";",e=b.lastIndexOf("\nreturn"),q=b.slice(0,e),e=b.slice(e),b=q+"\n"+e):b="\nreturn "+b+";"}try{c=Function.apply(y,l.concat("'use strict';\n"+n+b)),d.evaluator=Ea(g,c)}catch(F){v("debug: parse error,"+F.message)}finally{h=e=l=null}}}function K(b,c,d,e,f){c.cb(-1);Array.isArray(e)&&(b=e.map(function(b){return b.expr?"("+b.value+")":rc(b.value)}).join(" + "));xb(b,c,d);d.evaluator&&!f&&(d.handler=Fa[d.handlerName||d.type],ya(d))}function ba(b,
c){var d="_"+b;if(!ba[d]){var e=p.createElement(b);B.appendChild(e);c=w?getComputedStyle(e,null).display:e.currentStyle.display;B.removeChild(e);ba[d]=c}return ba[d]}function Ga(b){return null==b?"":b}function sc(b,c,d,e){c.param.replace(/\w+/g,function(e){(e=avalon.duplexHooks[e])&&"function"===typeof e[d]&&(b=e[d](b,c))});return b}function yb(b){var c=arguments.length?b:this.value;if(!this.disabled&&this.oldValue!==c)if(c=this.getAttribute("data-duplex-event")||"input",c=c.match(z).shift(),w){var d=
p.createEvent("Events");d.initEvent(c,!0,!0);d.isTrusted=!1;this.dispatchEvent(d)}else try{this.fireEvent("on"+c)}catch(e){}}function tc(){for(var b=ca.length-1;0<=b;b--)!1===(0,ca[b])()&&ca.splice(b,1);ca.length||clearInterval(zb)}function uc(b){vc.call(this,b);yb.call(this,b)}function wc(b){var c={},d;for(d in b)c[d]=b[d];d=c.target=b.srcElement;0===b.type.indexOf("key")?c.which=null!=b.charCode?b.charCode:b.keyCode:/mouse|click/.test(b.type)&&(d=d.ownerDocument||p,d="BackCompat"===d.compatMode?
...
gc=M("value,title,alt,checked,selected,disabled,readonly,enabled");if(!"1"[0])var Pa=Da(512),Xc=/\s+(ms-[^=\s]+)(?:=("[^"]*"|'[^']*'|[^\s>]+))?/g,Yc=/^['"]/,Zc=/<\w+\b(?:(["'])[^"]*?(\1)|[^>])*>/i,$c=/&amp;/g,sb=function(b){b=b.outerHTML;if("</"===b.slice(0,2)||!b.trim())return[];b=b.match(Zc)[0];var c=[],d,e;if(Pa[b])return Pa[b];for(;d=Xc.exec(b);)(e=d[2])&&(e=(Yc.test(e)?e.slice(1,-1):e).replace($c,"&")),d=d[1].toLowerCase(),d.match(tb),c.push({name:d,specified:!0,value:e||""});return Pa(b,c)};
var lc=/\|\s*(\w+)\s*(\([^)]*\))?/g,kc=/\|\|/g,mc=/U2hvcnRDaXJjdWl0/g,ic=/&lt;/g,jc=/&gt;/g,ad=/\/\*[\w\W]*?\*\/|\/\/[^\n]*\n|\/\/[^\n]*$|"(?:[^"\\]|\\[\w\W])*"|'(?:[^'\\]|\\[\w\W])*'|[\s\t\n]*\.[\s\t\n]*[$\w\.]+/g,bd=/[^\w$]+/g,cd=RegExp(""+("\\b"+"break,case,catch,continue,debugger,default,delete,do,else,false,finally,for,function,if,in,instanceof,new,null,return,switch,this,throw,true,try,typeof,var,void,while,with,abstract,boolean,byte,char,class,const,double,enum,export,extends,final,float,goto,implements,import,int,interface,long,native,package,private,protected,public,short,static,super,synchronized,throws,transient,volatile,arguments,let,yield,undefined".replace(/,/g,
