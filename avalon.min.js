...
b.concat();b.length=0;b=Mb(b);b.push.apply(b,e);return b}if("number"===typeof b.nodeType)return b;var f={};c=c||{};var g={},h={},e=[],k=d||{},l=b.$skipArray;d=0;for(var m;m=Nb[d++];)delete b[m],h[m]=!0;if(Array.isArray(l))for(d=0;m=l[d++];)"string"!==typeof m&&B("warning:$skipArray["+m+"] must be a string"),h[m]=!0;for(d in b)Ob(d,b[d],c,h,g,e,k);f=ia(f,Pb(g),h);for(m in h)f[m]=h[m];k.vmodel=f;f.$model=c;f.$events={};f.$id=Wa();f.$accessors=g;f[y]=[];for(d in K)b=K[d],v||(b=b.bind(f)),f[d]=b;f.hasOwnProperty=
...
b);d.length&&za(d,c)}}function Wb(b,c){return b.priority-c.priority}function hb(b,c){for(var d=kb?kb(b):avalon.slice(b.attributes),e=[],f={},g,h=0,k;k=d[h++];)if(k.specified&&(g=k.name.match(lb))){var l=g[1],m=g[2]||"",n=k.value;k=k.name;f[k]=n;Xb[l]?(m=l,l="on"):"enabled"===l&&(l="disabled",n="!("+n+")");if("checked"===l||"selected"===l||"disabled"===l||"readonly"===l)m=l,l="attr",b.removeAttribute(k),k="ms-attr-"+m,b.setAttribute(k,n),g=[k],f[k]=n;"function"===typeof E[l]&&(n={type:l,param:m,element:b,
name:g[0],value:n,priority:l in mb?mb[l]:10*l.charCodeAt(0)+(Number(m)||0)},"if"===l&&-1<m.indexOf("loop")&&(n.priority+=100),c.length&&(e.push(n),"widget"===l&&(b.msData=b.msData||f)))}e.sort(Wb);f["ms-checked"]&&f["ms-duplex"]&&B("warning!\u4e00\u4e2a\u5143\u7d20\u4e0a\u4e0d\u80fd\u540c\u65f6\u5b9a\u4e49ms-checked\u4e0ems-duplex");d=e[0]||{};switch(d.type){case "if":case "repeat":case "widget":za([d],c);break;default:za(e,c),!Yb[b.tagName]&&Aa.test(b.innerHTML.replace(nb,"<").replace(ob,">"))&&
xa(b,c)}if(b.patchRepeat){b.patchRepeat();try{b.patchRepeat="",b.removeAttribute("patchRepeat")}catch(p){}}}function za(b,c){for(var d=0,e;e=b[d++];)e.vmodels=c,E[e.type](e,c),e.evaluator&&e.name&&e.element.removeAttribute(e.name);b.length=0}function jb(b,c){0<b.indexOf("|")&&(b=b.replace(Zb,"U2hvcnRDaXJjdWl0"),b=b.replace($b,function(b,e,f){c.push(e+(f||""));return""}),b=b.replace(ac,"||"));return b}function ya(b){var c=[],d;d=0;var e;do{e=b.indexOf(L,d);if(-1===e)break;(d=b.slice(d,e))&&c.push({value:d,
...
(d[g]=c.push(f))}return c}function Ba(b){function c(e,f){d.push(e)>b&&delete c[d.shift()];return c[e]=f}var d=[];return c}function qa(b,c,d){var e=d.type,f="html"===e||"text"===e?d.filters:"",g=c.map(function(b){return b.$id.replace(cc,"$1")})+b+e+f,h=dc(b).concat(),k=[],l=[],m=[],n="";c=pb(c);for(var p=0,n=c.length;p<n;p++)if(h.length){var r="vm"+x+"_"+p;l.push(r);m.push(c[p]);k.push.apply(k,bc(h,c[p],r,e))}if(k.length||"duplex"!==e)if(f&&m.push(avalon.filters),d.args=m,c=Ca[g])d.evaluator=c;else{(n=
...
"\tSet o = (New "+e+")(a, b)","\tSet "+e+"Factory = o","End Function"].join("\r\n"));return s[b+"Factory"](c,wc)}}if(!"\u53f8\u5f92\u6b63\u7f8e".trim){var xc=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;String.prototype.trim=function(){return this.replace(xc,"")}}var yc=!{toString:null}.propertyIsEnumerable("toString"),zc=function(){}.propertyIsEnumerable("prototype"),Bb="toString toLocaleString valueOf hasOwnProperty isPrototypeOf propertyIsEnumerable constructor".split(" "),Ac=Bb.length;Object.keys||(Object.keys=
function(b){var c=[],d=zc&&"function"===typeof b;if("string"===typeof b||b&&b.callee)for(d=0;d<b.length;++d)c.push(String(d));else for(var e in b)!(d&&"prototype"===e)&&P.call(b,e)&&c.push(String(e));if(yc){d=(d=b.constructor)&&d.prototype===b;for(e=0;e<Ac;e++){var f=Bb[e];!(d&&"constructor"===f)&&P.call(b,f)&&c.push(f)}}return c});Array.isArray||(Array.isArray=function(b){return b&&"array"===avalon.type(b)});A.bind||(Function.prototype.bind=function(b){if(2>arguments.length&&void 0===b)return this;
...
uc;s.require=b?F:tc},interpolate:function(b){L=b[0];M=b[1];if(L===M)throw new SyntaxError("openTag!==closeTag");if("\x3c!--,--\x3e"===b+"")u.commentInterpolate=!0;else{b=L+"test"+M;O.innerHTML=b;if(O.innerHTML!==b&&0<=O.innerHTML.indexOf("&lt;"))throw new SyntaxError("\u6b64\u5b9a\u754c\u7b26\u4e0d\u5408\u6cd5");O.innerHTML=""}b=(L+"").replace(Eb,"\\$&");var c=(M+"").replace(Eb,"\\$&");ba=RegExp(b+"(.*?)"+c);Db=RegExp(b+"(.*?)"+c,"g");Aa=RegExp(b+".*?"+c+"|\\sms-")}};u.dettachVModels=u.debug=!0;u.plugins=
...
/^(\w+)!(\S+)$/.test(b)&&(c=RegExp.$1,b=RegExp.$2);for(var d=this.$events,e=d[b]||[],f=d.$all||[],g=aa.call(arguments,1),h=0,k;k=e[h++];)k.apply(this,g);for(h=0;k=f[h++];)k.apply(this,arguments);if(d=d.expr&&Hb(d.expr)){var l=[b].concat(g);if("up"===c||"down"===c||"all"===c){for(h in avalon.vmodels)if((g=avalon.vmodels[h])&&(g.$events&&g.$events.expr)&&g!==this)if((e=Hb(g.$events.expr))&&("all"===c||("down"===c?d.contains(e):e.contains(d))))e._avalon=g;var h=document.getElementsByTagName("*"),m=[];
Array.prototype.forEach.call(h,function(b){b._avalon&&(m.push(b._avalon),b._avalon="",b.removeAttribute("_avalon"))});"up"===c&&m.reverse();m.forEach(function(b){b.$fire.apply(b,l)})}}}},Oc=/(\w+)\[(avalonctrl)="(\d+)"\]/,Hb=document.querySelector?function(b){return document.querySelector(b)}:function(b){b=b.match(Oc);for(var c=document.getElementsByTagName(b[1]),d=0,e;e=c[d++];)if(e.getAttribute(b[2])===b[3])return e},Ub=/^(duplex|on)$/;avalon.scan=function(b,c){b=b||z;var d=c?[].concat(c):[];pa(b,
d)};var Yb=T("AREA,BASE,BASEFONT,BR,COL,COMMAND,EMBED,HR,IMG,INPUT,LINK,META,PARAM,SOURCE,TRACK,WBR,NOSCRIPT,SCRIPT,STYLE,TEXTAREA"),Vb=v?15:50,lb=/ms-(\w+)-?(.*)/,mb={"if":10,repeat:90,data:100,widget:110,each:1400,"with":1500,duplex:2E3,on:3E3},Xb=T("animationend,blur,change,input,click,dblclick,focus,keydown,keypress,keyup,mousedown,mouseenter,mouseleave,mousemove,mouseout,mouseover,mouseup,scan,scroll,submit");if(!"1"[0])var Ma=Ba(512),Pc=/\s+(ms-[^=\s]+)(?:=("[^"]*"|'[^']*'|[^\s>]+))?/g,Qc=/^['"]/,
Rc=/<\w+\b(?:(["'])[^"]*?(\1)|[^>])*>/i,Sc=/&amp;/g,kb=function(b){b=b.outerHTML;if("</"===b.slice(0,2)||!b.trim())return[];b=b.match(Rc)[0];var c=[],d,e;if(Ma[b])return Ma[b];for(;d=Pc.exec(b);)(e=d[2])&&(e=(Qc.test(e)?e.slice(1,-1):e).replace(Sc,"&")),d=d[1].toLowerCase(),d.match(lb),c.push({name:d,specified:!0,value:e||""});return Ma(b,c)};var $b=/\|\s*(\w+)\s*(\([^)]*\))?/g,Zb=/\|\|/g,ac=/U2hvcnRDaXJjdWl0/g,nb=/&lt;/g,ob=/&gt;/g,Tc=/\/\*[\w\W]*?\*\/|\/\/[^\n]*\n|\/\/[^\n]*$|"(?:[^"\\]|\\[\w\W])*"|'(?:[^'\\]|\\[\w\W])*'|[\s\t\n]*\.[\s\t\n]*[$\w\.]+/g,
Uc=/[^\w$]+/g,Vc=RegExp(""+("\\b"+"break,case,catch,continue,debugger,default,delete,do,else,false,finally,for,function,if,in,instanceof,new,null,return,switch,this,throw,true,try,typeof,var,void,while,with,abstract,boolean,byte,char,class,const,double,enum,export,extends,final,float,goto,implements,import,int,interface,long,native,package,private,protected,public,short,static,super,synchronized,throws,transient,volatile,arguments,let,yield,undefined".replace(/,/g,"\\b|\\b")+"\\b"),"g"),Wc=/\b\d[^,]*/g,
Xc=/^,+|,+$/g,Na=Ba(512),dc=function(b){var c=","+b.trim();if(Na[c])return Na[c];b=b.replace(Tc,"").replace(Uc,",").replace(Vc,"").replace(Wc,"").replace(Xc,"").split(/^$|,+/);return Na(c,pb(b))},Ca=Ba(128),ec=/\w\[.*\]|\w\.\w/,cc=/(\$proxy\$[a-z]+)\d+$/,Yc={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},fc=s.JSON&&JSON.stringify||function(b){return'"'+b.replace(/[\\\"\x00-\x1f]/g,function(b){var d=Yc[b];return"string"===typeof d?d:"\\u"+("0000"+b.charCodeAt(0).toString(16)).slice(-4)})+
...
c,d){if(b){var e=this.group,f=this.startRepeat?this.startRepeat.parentNode:this.callbackElement,g=this.proxies,h=Q.cloneNode(!1);if("del"===b||"move"===b)var k=Fa(f,this,c);switch(b){case "add":for(var l=d,m=this.getter().length-1,e=[],n={},k=0,p=l.length;k<p;k++){var n=k+c,r=qc(n,l[k],this,m);g.splice(n,0,r);n=vb(this,h,e,r)}k=Fa(f,this,c);n.node=k;n.parent=f;f.insertBefore(h,k);for(k=0;n=e[k++];)pa(n,this.vmodels);break;case "del":h=g.splice(c,d);va(h);Ea(wb(k,e,d));break;case "index":for(m=g.length-
...
m.push(l);k&&(k=k.call(f,m))&&(Array.isArray(k)&&k.length)&&(m=k);for(k=0;l=m[k++];)"hasOwnProperty"!==l&&(n=vb(this,h,e,g[l]));n.parent=f;n.node=this.endRepeat||null;f.insertBefore(h,n.node);for(k=0;d=e[k++];)pa(d,this.vmodels)}mc.call(this,arguments,f)}},html:function(b,c,d){b=null==b?"":b;c||(c=d.element=d.node.parentNode);if(d.replaceNodes){var e;if(11===b.nodeType)e=b;else if(1===b.nodeType||b.item){b=1===b.nodeType?b.childNodes:b.item?b:[];for(e=Q.cloneNode(!0);b[0];)e.appendChild(b[0])}else e=
...
for(f=0;m=c[f++];)if(m.hasOwnProperty(g)&&m.hasOwnProperty(l)){b.$outer=m;break}l=h.firstChild;b.fastRepeat=!!l&&1===l.nodeType&&h.lastChild===l&&!l.attributes["ms-controller"]&&!l.attributes["ms-important"];e[y]&&e[y].push(b);D(e);if(!Array.isArray(e)&&"each"!==d){var p=V[e.$id];if(!p){na++;var p=V[e.$id]={},r;for(r in e)e.hasOwnProperty(r)&&"hasOwnProperty"!==r&&function(b,c){p[b]=pc(b,c,{});p[b].$watch("$val",function(c){e[b]=c})}(r,e[r])}b.handler("append",e,p)}else b.handler("add",0,e)}},html:function(b,
...
91===c||(15<c&&19>c||37<=c&&40>=c)||("cut"===b.type?avalon.nextTick(r):r())};ka.forEach(function(c){b.attachEvent("on"+c,la)});d.rollback=function(){ka.forEach(function(c){b.detachEvent("on"+c,la)})}}b.oldValue=b.value;Jb(function(){if(avalon.contains(z,b))gc.call(b);else if(!b.msRetain)return!1});ua(d);var Qb=setTimeout(function(){k||m.call(b,b.value);clearTimeout(Qb)},31)};var rb,da=[],Jb=A;avalon.tick=function(b){1===da.push(b)&&(rb=setInterval(hc,30))};try{var Ta=HTMLInputElement.prototype;Object.getOwnPropertyNames(Ta);
var jc=Object.getOwnPropertyDescriptor(Ta,"value").set;Object.defineProperty(Ta,"value",{set:ic})}catch(ld){Jb=avalon.tick}Y.SELECT=function(b,c,d){var e=avalon(b);d.handler=function(){var d=c(),d=d&&d.$model||d,d=Array.isArray(d)?d.map(String):d+"";d+""!==b.oldValue&&(e.val(d),b.oldValue=d+"")};d.bound("change",function(){if(!1!==e.data("duplex-observe")){var f=e.val();f+""!==b.oldValue&&(c(f),b.oldValue=f+"");d.changed.call(b,f)}});var f=NaN,g=setInterval(function(){var e=b.innerHTML;e===f?(clearInterval(g),
...
document.createElement("input")||(ha.input={type:"propertychange",deel:function(b,c){return function(d){if("value"===d.propertyName)return d.type="input",c.call(b,d)}}});if(void 0===document.onmousewheel){var Kb=void 0!==document.onwheel?"wheel":"DOMMouseScroll",bd="wheel"===Kb?"deltaY":"detail";ha.mousewheel={type:Kb,deel:function(b,c){return function(d){d.wheelDeltaY=d.wheelDelta=0<d[bd]?-120:120;d.wheelDeltaX=0;Object.defineProperty&&Object.defineProperty(d,"type",{value:"mousewheel"});c.call(b,
